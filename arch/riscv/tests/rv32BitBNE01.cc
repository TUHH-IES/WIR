...
int main( void )
{
  ...
  ufAssert( uval( bne1, 0 ).extract( 0, 6 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( bne1, 0 ).extract( 6, 1 ).containsOnlyBit( WIR_L4::b1 ) );
  ufAssert( uval( bne1, 0 ).extract( 7, 25 ).containsOnlyBit( WIR_L4::bX ) );

  ufAssert( uval( bne1, 1 ).extract( 0, 6 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( bne1, 1 ).extract( 6, 1 ).containsOnlyBit( WIR_L4::b0 ) );
  ufAssert( uval( bne1, 1 ).extract( 7, 25 ).containsOnlyBit( WIR_L4::bX ) );
