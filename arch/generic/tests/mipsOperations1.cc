...
int main( void )
{
  ...
  ufAssert(
    !addiu1.isImplicitMemoryAccess() && !addiu1.isMemoryStore() &&
  ...
  ufAssert(
    !addu1.isImplicitMemoryAccess() && !addu1.isMemoryStore() &&
  ...
  ufAssert(
    !mfco1.isImplicitMemoryAccess() && !mfco1.isMemoryStore() &&
  ...
  ufAssert(
    !mfhi1.isImplicitMemoryAccess() && !mfhi1.isMemoryStore() &&
  ...
  ufAssert(
    !mflo1.isImplicitMemoryAccess() && !mflo1.isMemoryStore() &&
  ...
  ufAssert(
    !mult1.isImplicitMemoryAccess() && !mult1.isMemoryStore() &&
  ...
  ufAssert(
    !multu1.isImplicitMemoryAccess() && !multu1.isMemoryStore() &&
  ...
  ufAssert(
    !sllv1.isImplicitMemoryAccess() && !sllv1.isMemoryStore() &&
  ...
  ufAssert(
    !srav1.isImplicitMemoryAccess() && !srav1.isMemoryStore() &&
  ...
  ufAssert(
    !srlv1.isImplicitMemoryAccess() && !srlv1.isMemoryStore() &&
  ...
  ufAssert(
    !subu1.isImplicitMemoryAccess() && !subu1.isMemoryStore() &&
