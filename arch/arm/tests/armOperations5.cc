...
int main( void )
{
  ...
  // The following must assert since operation format CRRRAR_1 only accepts
  // data-processing addressing modes, and not memory addressing modes.
  WIR_Operation o(
    ARMv4::OpCode::ADD, ARMv4::OperationFormat::CRRRAR_1, WIR_ConditionFieldParameter( ARMv4::Condition::eq ),
  ...
  ufAssertT(
    regP.getAddressingMode().isCompatible(
      ARMv4::AddressingMode::lsl, ARMv4::OperationFormat::CRRRAR_1,
      ARMv4::OpCode::ADD ),
