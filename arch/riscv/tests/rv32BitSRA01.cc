...
int main( void )
{
 ...
 // Evaluate analysis results.
  ufAssert( uval( sra1, 1 ).extract( 0, 16 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( sra1, 1 ).extract( 16, 8 ).getSignedValue() == 123 );
  ufAssert( uval( sra1, 1 ).extract( 24, 8 ).getSignedValue() == 255 );

  ufAssert( dval( sra1, 0 ).extract( 0, 32 ).getSignedValue() == -33984 );

  ufAssert( uval( sra2, 1 ).extract( 0, 8 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( sra2, 1 ).extract( 8, 8 ).getSignedValue() == 123 );
  ufAssert( uval( sra2, 1 ).extract( 16, 8 ).getSignedValue() == -1 );
  ufAssert( uval( sra2, 1 ).extract( 24, 8 ).getSignedValue() == -1 );

  ufAssert( dval( sra2, 0 ).extract( 0, 32 ).getSignedValue() == -133 );
