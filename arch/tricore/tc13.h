...
class TC13 : public WIR_Processor<TC13>
{
  ...
  public:
    ...
    */
    ...
    /*!
      @brief boolBytes contains the width of a _Bool in bytes for the TriCore
             architecture.
    */
    static const int boolBytes = ( 8 / 8 );

    /*!
      @brief charBytes contains the width of a char in bytes for the TriCore
             architecture.
    */
    static const int charBytes = ( 8 / 8 );

    /*!
      @brief shortBytes contains the width of a short in bytes for the TriCore
             architecture.
    */
    static const int shortBytes = ( 16 / 8 );

    /*!
      @brief intBytes contains the width of an int in bytes for the TriCore
             architecture.
    */
    static const int intBytes = ( 32 / 8 );

    /*!
      @brief longBytes contains the width of a long in bytes for the TriCore
             architecture.
    */
    ...
    */
    ...
    /*!
      @brief pointerBytes contains the width of a pointer in bytes for the
             TriCore architecture.
    */
    static const int pointerBytes = ( 32 / 8 );

    /*!
      @brief floatBytes contains the width of a float in bytes for the TriCore
             architecture.
    */
    static const int floatBytes = ( 32 / 8 );

    /*!
      @brief doubleBytes contains the width of a double in bytes for the TriCore
             architecture.
    */
    static const int doubleBytes = ( 64 / 8 );

    /*!
      @brief longDoubleBytes contains the width of a long double in bytes for
