...
int main( void )
{
  ...
  ufAssert( dval( nor1, 0 ).getSignedValue() == 0x00FFFF00 );
  ufAssert( uval( nor1, 1 ).extract( 0, 2 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( nor1, 1 ).at( 2 ) == WIR_L4::b1 );
  ufAssert( uval( nor1, 1 ).extract( 3, 4 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( nor1, 1 ).extract( 7, 25 ).isBinaryInteger() );
  ufAssert( uval( nor1, 2 ).extract( 0, 2 ).isBinaryInteger() );
  ufAssert( uval( nor1, 2 ).at( 2 ) == WIR_L4::bX );
  ufAssert( uval( nor1, 2 ).extract( 3, 4 ).isBinaryInteger() );
  ufAssert( uval( nor1, 2 ).at( 7 ) == WIR_L4::bX );
  ufAssert( uval( nor1, 2 ).at( 8 ) == WIR_L4::b0 );

  ufAssert( dval( nort1, 0 ).extract( 1, 31  ).containsOnlyBit( WIR_L4::b0 ) );
  ufAssert( dval( nort1, 0 ).at( 0 ) == WIR_L4::b0 );
  ufAssert( uval( nort1, 1 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( nort1, 3 ).extract( 0, 6 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( nort1, 3 ).at( 6 ) == WIR_L4::b1 );
  ufAssert( uval( nort1, 3 ).extract( 7, 25 ).containsOnlyBit( WIR_L4::bX ) );

  ufAssert( dval( nort2, 0 ).extract( 1, 31  ).containsOnlyBit( WIR_L4::b0 ) );
  ufAssert( dval( nort2, 0 ).at( 0 ) == WIR_L4::b1 );
  ufAssert( uval( nort2, 1 ).extract( 0, 5 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( nort2, 1 ).at( 5 ) == WIR_L4::b0 );
  ufAssert( uval( nort2, 1 ).extract( 6, 26 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( nort2, 3 ).extract( 0, 5 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( nort2, 3 ).at( 5 ) == WIR_L4::b0 );
  ufAssert( uval( nort2, 3 ).extract( 6, 26 ).containsOnlyBit( WIR_L4::bX ) );
