...
int main( void )
{
  ...
  rv32op(
    { RV32I::OpCode::ADDI, RV32I::OperationFormat::RRC12_1,
      ...
      new RV_Const12_Signed( 727 ) } );

  rv32op(
    { RV32I::OpCode::ADDI, RV32I::OperationFormat::RRC12_1,
      new WIR_RegisterParameter( input2, WIR_Usage::def ),
      new WIR_RegisterParameter( p.x0(), WIR_Usage::use ),
      new RV_Const12_Signed( 1685 ) } );
  ...
  ufAssert( uval( bltu1, 1 ).extract( 0, 10 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( bltu1, 1 ).extract( 10, 1 ).containsOnlyBit( WIR_L4::b1 ) );
  ufAssert( uval( bltu1, 1 ).extract( 11, 21 ).containsOnlyBit( WIR_L4::b0 ) );

  ufAssert( uval( bltu1, 0 ).extract( 0, 10 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( bltu1, 0 ).extract( 10, 22 ).containsOnlyBit( WIR_L4::b0 ) );
