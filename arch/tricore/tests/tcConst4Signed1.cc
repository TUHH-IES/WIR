...
int main( void )
{
  ...
  TC_Const4_Signed p1( 0 );
  TC_Const4_Signed p2( 1 );
  TC_Const4_Signed p3( -3 );
  ...
  auto ref2 = dynamic_cast<TC_Const4_Signed &>( ref1 );
  ufAssert( ref2.getValue() == p1.getValue() );

  // Test the copy constructors.
  TC_Const4_Signed p4( p1 );
  TC_Const4_Signed p5( p2 );
  TC_Const4_Signed p6( p3 );
  ...
  auto ref4 = dynamic_cast<TC_Const4_Signed &>( ref3 );
  ufAssert( ref4.getValue() == p5.getValue() );

  // Test the move constructors.
  TC_Const4_Signed p7( std::move( p4 ) );
  TC_Const4_Signed p8( std::move( p5 ) );
  TC_Const4_Signed p9( std::move( p6 ) );
  ...
  auto ref6 = dynamic_cast<TC_Const4_Signed &>( ref5 );
  ufAssert( ref6.getValue() == p8.getValue() );

  // Test the copy assignment operator.
  TC_Const4_Signed p10( -8 );
  p10 = p1;
  TC_Const4_Signed p11( -3 );
  p11 = p2;
  TC_Const4_Signed p12( 4 );
  p12 = p3;
  ...
  auto ref8 = dynamic_cast<TC_Const4_Signed &>( ref7 );
  ufAssert( ref8.getValue() == p10.getValue() );

  // Test the move assignment operator.
  TC_Const4_Signed p13( -8 );
  p13 = std::move( p10 );
  TC_Const4_Signed p14( -3 );
  p14 = std::move( p11 );
  TC_Const4_Signed p15( 4 );
  p15 = std::move( p12 );
  ...
  auto ref10 = dynamic_cast<TC_Const4_Signed &>( ref9 );
  ufAssert( ref10.getValue() == p14.getValue() );

  // Check min/max signed values for 4 bits.
  TC_Const4_Signed p16( -8 );
  TC_Const4_Signed p17( 7 );
