                                  ...
                                  public WIR_Name_API
{
  ...
  public:
    ...
    */
    ...
    {
      DSTART(
        "WIR_CompilationUnit::WIR_CompilationUnit(WIR_Function&&, "
        "Args&& ...)" );
    ...
    */
    ...
    /*!
      @brief getDataLayout computes a map representing a compilation unit's data
             layout.

      @return A map that, for each %WIR section, groups together all data
              objects of a compilation unit which will be linked into the
              associated section.
  ...
  private:
    ...
    */
    ...
    {
      DSTART(
        "void WIR_CompilationUnit::addFunctions(WIR_Function&&, Args&& ...)" );
