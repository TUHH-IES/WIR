...
WIR_Function::WIR_Function( WIR_Function &&__o ) :
  ...
  mBasicBlocks { std::move( __o.mBasicBlocks ) },
  mBasicBlockReferences { std::move( __o.mBasicBlockReferences ) },
  mVirtualRegisterPointers { std::move( __o.mVirtualRegisterPointers ) },
  mVirtualRegisterReferences { std::move( __o.mVirtualRegisterReferences ) },
  mCompilationUnitPointer { nullptr },
  mPrecolors { std::move( __o.mPrecolors ) },
  mInterferences { std::move( __o.mInterferences ) },
  mDontOptimize { __o.mDontOptimize },
  mCheckVREGs { __o.mCheckVREGs },
  mName { std::move( __o.mName ) },
  mFrameSize { std::move( __o.mFrameSize ) },
  mFunctionInputs { std::move( __o.mFunctionInputs ) }
{
...
WIR_BasicBlock & WIR_Function::pushBackBasicBlock( WIR_BasicBlock &&o )
{
  ...
  mBasicBlocks.emplace_back( std::move( o ) );
  mBasicBlocks.back().onInsert( this );
  mBasicBlockReferences.push_back( mBasicBlocks.back() );
...
WIR_BasicBlock & WIR_Function::pushFrontBasicBlock( WIR_BasicBlock &&o )
{
  ...
  mBasicBlocks.emplace_front( std::move( o ) );
  mBasicBlocks.front().onInsert( this );
  mBasicBlockReferences.push_front( mBasicBlocks.front() );
                                                                                            ...
                                                                                            WIR_BasicBlock &&o )
{
  ...
  for ( auto itr = mBasicBlockReferences.begin(); itr != pos;
        ++itr, ++it, --rit ) ;
  WIR_BasicBlock *prevPred = ( rit == mBasicBlocks.rend() ) ? nullptr : &(*rit);
  auto it1 = mBasicBlocks.insert( it, std::move( o ) );
  (*it1).onInsert( this );
                                                                                            ...
                                                                                            WIR_BasicBlock &&o )
{
  ...
  WIR_BasicBlock *prevPred = ( rit == mBasicBlocks.rend() ) ? nullptr : &(*rit);
  WIR_BasicBlock *prevSucc = pos->get().mDirectSuccessor;
  auto it2 = mBasicBlocks.insert( it1, std::move( o ) );
  (*it2).onInsert( this );
...
bool WIR_Function::containsBasicBlock( WIR_id_t id ) const
{
  ...
  return(
    any_of(
      mBasicBlocks.begin(), mBasicBlocks.end(),
      [&]( const WIR_BasicBlock &b ) { return( b.getID() == id ); } ) );
};
...
bool WIR_Function::containsBasicBlock( const WIR_BasicBlock &o ) const
{
  ...
  return(
    any_of(
      mBasicBlocks.begin(), mBasicBlocks.end(),
      [&]( const WIR_BasicBlock &b ) { return( b == o ); } ) );
};
...
std::list<std::reference_wrapper<WIR_BasicBlock>>::const_iterator WIR_Function::findBasicBlock( WIR_id_t id ) const
{
  ...
  return(
    find_if(
      mBasicBlockReferences.begin(), mBasicBlockReferences.end(),
      [&]( reference_wrapper<WIR_BasicBlock> ref ) {
...
bool WIR_Function::containsVirtualRegister( WIR_id_t id ) const
{
  ...
  return(
    any_of(
      mVirtualRegisterReferences.begin(), mVirtualRegisterReferences.end(),
      [&]( const WIR_VirtualRegister &r ) { return( r.getID() == id ); } ) );
};
...
bool WIR_Function::containsVirtualRegister( const WIR_VirtualRegister &o ) const
{
  ...
  return(
    any_of(
      mVirtualRegisterReferences.begin(), mVirtualRegisterReferences.end(),
      [&]( const WIR_VirtualRegister &r ) { return( r == o ); } ) );
};
...
std::list<std::reference_wrapper<WIR_VirtualRegister>>::const_iterator WIR_Function::findVirtualRegister( WIR_id_t id ) const
{
  ...
  return(
    find_if(
      mVirtualRegisterReferences.begin(), mVirtualRegisterReferences.end(),
      [&]( reference_wrapper<WIR_VirtualRegister> ref ) {
        return( ref.get().getID() == id ); } ) );
};
...
unsigned long long WIR_Function::getSize( void ) const
{
  ...
  return(
    accumulate(
      getBasicBlocks().begin(), getBasicBlocks().end(), res,
      []( unsigned long long i, const WIR_BasicBlock &b ) {
        return( i + b.getSize() ); } ) );
};
                                   ...
                                   const WIR_PhysicalRegister &p )
{
  ...
  do {
    const WIR_VirtualRegister &vReg = *(vWorklist.front());
    vWorklist.pop_front();
    WIR_PhysicalRegister &pReg = *(pWorklist.front());
    pWorklist.pop_front();

    mPrecolors[ const_cast<WIR_VirtualRegister &>( vReg ) ] = &pReg;

    transform(
      vReg.begin(), vReg.end(), back_inserter( vWorklist ),
      [&]( WIR_VirtualRegister &c ) { return( &c ); } );
    transform(
      pReg.begin(), pReg.end(), back_inserter( pWorklist ),
      [&]( WIR_PhysicalRegister &c ) { return( &c ); } );
...
WIR_VirtualRegisterSet WIR_Function::getVREGs( void ) const
{
  ...
  for ( const WIR_BasicBlock &b : getBasicBlocks() )
...
void WIR_Function::copyFunction( const WIR_Function &__o )
{
  ...
  transform(
    __o.mVirtualRegisterReferences.begin(),
    __o.mVirtualRegisterReferences.end(), back_inserter( originalIDs ),
    [&]( const WIR_VirtualRegister &r ) { return( r.getID() ); } );
  ...
  for ( auto id : originalIDs ) {
    ...
    do {
      ...
      transform(
        origReg->begin(), origReg->end(), back_inserter( origRegs ),
        [&]( WIR_VirtualRegister &c ) { return( &c ); } );
      transform(
        newReg->begin(), newReg->end(), back_inserter( newRegs ),
        [&]( WIR_VirtualRegister &c ) { return( &c ); } );
  ...
  clearBasicBlocks();
  mCheckVREGs = false;
  for ( const WIR_BasicBlock &b : __o.mBasicBlockReferences ) {
    pushBackBasicBlock( std::move( *(blockIDMap[ b.getID() ]) ) );
        ...
        for ( auto it = o.getParameters().begin();
          ...
          if ( p.getType() == WIR_ParameterType::reg ) {
            ...
            if ( r.isVirtual() ) {
              ...
              const auto &newvr = *(registerIDMap[ vr.getID() ]);
    ...
    for ( WIR_Instruction &i : b )
      for ( WIR_Operation &o : i ) {
        if ( o.jumpTargetsAdded() ) {
          for ( const WIR_BasicBlock &target : o.getJumpTargets() )
        ...
        for ( auto it = o.getParameters().begin();
          ...
          if ( p.getType() == WIR_ParameterType::label ) {
            const auto &labP = dynamic_cast<const WIR_LabelParameter &>( p );

            if ( labP.getLabelType() == WIR_SymbolType::block ) {
              const WIR_BasicBlock &labelB = labP.getBasicBlock();
            ...
            if ( labP.getLabelType() == WIR_SymbolType::function ) {
              const WIR_Function &labelF = labP.getFunction();
