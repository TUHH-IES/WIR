...
int main( void )
{
  ...
  // Check bit widths.
  ufAssert( RV32IF::RegisterType::fReg.getBitWidth() == 32  );

  ufAssert( p1.f0().getBitWidth() == 32 );
  ufAssert( p1.f1().getBitWidth() == 32 );
  ufAssert( p1.f2().getBitWidth() == 32 );
  ufAssert( p1.f3().getBitWidth() == 32 );
  ufAssert( p1.f4().getBitWidth() == 32 );
  ufAssert( p1.f5().getBitWidth() == 32 );
  ufAssert( p1.f6().getBitWidth() == 32 );
  ufAssert( p1.f7().getBitWidth() == 32 );
  ufAssert( p1.f8().getBitWidth() == 32 );
  ufAssert( p1.f9().getBitWidth() == 32 );
  ufAssert( p1.f10().getBitWidth() == 32 );
  ufAssert( p1.f11().getBitWidth() == 32 );
  ufAssert( p1.f12().getBitWidth() == 32 );
  ufAssert( p1.f13().getBitWidth() == 32 );
  ufAssert( p1.f14().getBitWidth() == 32 );
  ufAssert( p1.f15().getBitWidth() == 32 );
  ufAssert( p1.f16().getBitWidth() == 32 );
  ufAssert( p1.f17().getBitWidth() == 32 );
  ufAssert( p1.f18().getBitWidth() == 32 );
  ufAssert( p1.f19().getBitWidth() == 32 );
  ufAssert( p1.f20().getBitWidth() == 32 );
  ufAssert( p1.f21().getBitWidth() == 32 );
  ufAssert( p1.f22().getBitWidth() == 32 );
  ufAssert( p1.f23().getBitWidth() == 32 );
  ufAssert( p1.f24().getBitWidth() == 32 );
  ufAssert( p1.f25().getBitWidth() == 32 );
  ufAssert( p1.f26().getBitWidth() == 32 );
  ufAssert( p1.f27().getBitWidth() == 32 );
  ufAssert( p1.f28().getBitWidth() == 32 );
  ufAssert( p1.f29().getBitWidth() == 32 );
  ufAssert( p1.f30().getBitWidth() == 32 );
  ufAssert( p1.f31().getBitWidth() == 32 );
