...
class WIR_BaseProcessor : public WIR_SystemComponent
{
  ...
  public:
    ...
    */
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    virtual WIR_SystemComponentType getType( void ) const override;
    ...
    class OpCode : public WIR_InheritableEnum
    {
      ...
      public:
        ...
        */
        ...
        /*!
          @brief isImplicitMemoryAccess returns whether an opcode implicitly
                 accesses memory without being an explicit load or store
                 operation.

          @param[in] o A const reference to an operation to be checked.

          @return true if the opcode implicitly accesses memory, false
                  otherwise.
          ...
          @author Heiko Falk <Heiko.Falk@tuhh.de>
        */
        virtual bool isImplicitMemoryAccess( const WIR_Operation & ) const;
      ...
      protected:
        ...
        */
        ...
        /*!
          @brief Default constructor for opcodes without any specific
                 properties.

          @param[in] s A const reference to a string holding the opcode's
                       mnemonic.

          @author Heiko Falk <Heiko.Falk@tuhh.de>
        */
        explicit OpCode( const std::string & );

        /*!
          @brief Default constructor for opcodes with specific properties.

          @tparam Args R-value references of type WIR_OpCodeType.
          @param[in] s A const reference to a string holding the opcode's
                       mnemonic.
          @param[in] t Information about the type of an opcode.
          @param[in] __args A variadic number of R-value references to
                            specifiers of %WIR opcode types.

          This constructor uses variadic templates so that argument lists with
          opcode properties of arbitrary lengths can be passed to it.

          @author Heiko Falk <Heiko.Falk@tuhh.de>
        */
        template<typename... Args>
        OpCode( const std::string &s, WIR_OpCodeType t, Args&&... __args ) :
          WIR_InheritableEnum {},
          mName { s },
        ...
        {
          DSTART(
            "WIR_BaseProcessor::OpCode::OpCode(const string&, WIR_OpCodeType, "
            "Args&& ...)" );

          addType( t );
          addTypes( std::forward<Args>( __args )... );
        };
        ...
        */
        ...
        /*!
          @brief mIsImplicitMemoryAccess specifies whether an opcode implicitly
                 accesses memory without being an explicit load or store
                 operation.
        */
        bool mIsImplicitMemoryAccess;
      ...
      private:
        ...
        /*!
          @brief addType adds a concrete opcode type by setting the class'
          ...
          @author Heiko Falk <Heiko.Falk@tuhh.de>
        */
        void addType( WIR_OpCodeType );

        /*!
          @brief addTypes adds the given list of opcode type specifiers to this
                opcode.

          @tparam Args R-value references of type WIR_OpCodeType.
          @param[in] t Information about the type of an opcode.
          @param[in] args A variadic number of R-value references to specifiers
                          of %WIR opcode types.

          addTypes uses variadic templates so that argument lists with opcode
          properties of arbitrary lengths can be passed to it.

          @author Heiko Falk <Heiko.Falk@tuhh.de>
        */
        template<typename... Args>
        void addTypes( WIR_OpCodeType t, Args&&... args )
        {
          DSTART(
            "void WIR_BaseProcessor::OpCode::addTypes(WIR_OpCodeType, Args&& "
            "...)" );

          addType( t );
          addTypes( std::forward<Args>( args )... );
        };

        /*!
          @brief Dummy function for adding opcode type information which does
                 nothing.
    ...
    class RegisterType : public WIR_InheritableEnum
    {
      ...
      public:
        ...
        */
        ...
        /*!
          @brief setBitWidth sets a register type's bit width.

          @param[in] w An unsigned integer holding the register type's bit
                       width.

          @author Abhirami Meera Sreekumar <Abhirami.Meera.Sreekumar@tuhh.de>
        */
        void setBitWidth( unsigned int );
        ...
        */
        ...
        /*!
          ...
          @param[in] t A const reference to the register type that is required
                       by an operation format.
      ...
      protected:
        ...
        */
        ...
        /*!
          ...
          @author Heiko Falk <Heiko.Falk@tuhh.de>
        */
        RegisterType( const std::string &, const std::string &,
      ...
      protected:
        ...
        */
        ...
        /*!
          ...
          @author Heiko Falk <Heiko.Falk@tuhh.de>
        */
        OperationFormat( unsigned int, const std::string & );
  ...
  protected:
    ...
    */
    ...
    /*!
      @brief registerProcessor is a wrapper around the corresponding method of
             class WIR_Registry.
    ...
    */
    ...
    /*!
      @brief registerOperationFormat is a wrapper around the corresponding
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    static void registerOperationFormat( const OperationFormat &,
                                         WIR_OperationFormat && );

    /*!
      @brief registerOpCode is a wrapper around the corresponding method of
             class WIR_Registry.
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    static void registerOpCode( const OpCode &, const OperationFormat & );

    /*!
      @brief registerBasicBlockDumper is a wrapper around the corresponding
             method of class WIR_Registry.
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    static void registerBasicBlockDumper( unsigned int, WIR_BasicBlockDumper );

    /*!
      @brief registerBlockLabelDumper is a wrapper around the corresponding
             method of class WIR_Registry.
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    static void registerBlockLabelDumper( unsigned int, WIR_BlockLabelDumper );

    /*!
      @brief registerCommentDumper is a wrapper around the corresponding
             method of class WIR_Registry.
    ...
    */
    ...
    /*!
      @brief registerCompilationUnitDumper is a wrapper around the corresponding
             method of class WIR_Registry.
    ...
    */
    ...
    /*!
      @brief registerDataDumper is a wrapper around the corresponding
             method of class WIR_Registry.
    ...
    */
    ...
    /*!
      @brief registerDataSectionDumper is a wrapper around the corresponding
             method of class WIR_Registry.
    ...
    */
    ...
    /*!
      @brief registerFileInfoDumper is a wrapper around the corresponding
             method of class WIR_Registry.
    ...
    */
    ...
    /*!
      @brief registerFunctionDumper is a wrapper around the corresponding
             method of class WIR_Registry.
    ...
    */
    ...
    /*!
      @brief registerInstructionDumper is a wrapper around the corresponding
             method of class WIR_Registry.
    ...
    */
    ...
    /*!
      @brief registerOperationDumper is a wrapper around the corresponding
             method of class WIR_Registry.
    ...
    */
    ...
    /*!
      @brief registerAddressingModeParameterDumper is a wrapper around the
             corresponding method of class WIR_Registry.
    ...
    */
    ...
    /*!
      @brief registerConditionFieldParameterDumper is a wrapper around the
             corresponding method of class WIR_Registry.
    ...
    */
    ...
    /*!
      @brief registerImmediateParameterDumper is a wrapper around the
             corresponding method of class WIR_Registry.
    ...
    */
    ...
    /*!
      @brief registerLabelParameterDumper is a wrapper around the corresponding
             method of class WIR_Registry.
    ...
    */
    ...
    /*!
      @brief registerLdScriptDumper is a wrapper around the corresponding
             method of class WIR_Registry.
    ...
    */
    ...
    /*!
      @brief registerLdScriptSectionDumper is a wrapper around the corresponding
             method of class WIR_Registry.
    ...
    */
    ...
    /*!
      @brief registerLdScriptBetweenSectionDumper is a wrapper around the
             corresponding method of class WIR_Registry.
    ...
    */
    static void registerLdScriptBetweenSectionDumper( unsigned int,
                                               WIR_LdScriptBetweenSectionDumper );

    /*!
      @brief registerRegisterParameterDumper is a wrapper around the
             corresponding method of class WIR_Registry.
    ...
    */
    ...
    /*!
      @brief registerSystemDumper is a wrapper around the
             corresponding method of class WIR_Registry.
  ...
  private:
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    virtual unsigned int getMaxDelay( const unsigned int d = 0 ) const override;
    ...
    */
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    virtual WIR_BaseProcessor *clone( void ) const override = 0;
