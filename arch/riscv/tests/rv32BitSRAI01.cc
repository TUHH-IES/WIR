...
int main( void )
{
 ...
 // Evaluate analysis results.
  ufAssert( uval( srai1, 1 ).extract( 0, 16 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( srai1, 1 ).extract( 16, 8 ).getSignedValue() == 123 );
  ufAssert( uval( srai1, 1 ).extract( 24, 8 ).getSignedValue() == 255 );

  ufAssert( dval( srai1, 0 ).extract( 0, 32 ).getSignedValue() == -33984 );

  ufAssert( uval( srai2, 1 ).extract( 0, 8 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( srai2, 1 ).extract( 8, 8 ).getSignedValue() == 123 );
  ufAssert( uval( srai2, 1 ).extract( 16, 8 ).getSignedValue() == -1 );
  ufAssert( uval( srai2, 1 ).extract( 24, 8 ).getSignedValue() == -1 );

  ufAssert( dval( srai2, 0 ).extract( 0, 32 ).getSignedValue() == -133 );
