...
int main( void )
{
  ...
  ARM_Const10_CoprocessorOffset p1( 0 );
  ARM_Const10_CoprocessorOffset p2( 12 );
  ARM_Const10_CoprocessorOffset p3( 444 );
  ...
  ufAssert( p3.getValue() == 444 );

  p1.setValue( 1000 );
  p2.setValue( 72 );
  p3.setValue( 8 );

  ufAssert( p1.getValue() == 1000 );
  ufAssert( p2.getValue() == 72 );
  ufAssert( p3.getValue() == 8 );
  ...
  auto ref2 = dynamic_cast<ARM_Const10_CoprocessorOffset &>( ref1 );
  ufAssert( ref2.getValue() == p1.getValue() );

  // Test the copy constructors.
  ARM_Const10_CoprocessorOffset p4( p1 );
  ARM_Const10_CoprocessorOffset p5( p2 );
  ARM_Const10_CoprocessorOffset p6( p3 );

  ufAssert( p4.getType() == WIR_ParameterType::imm );
  ufAssert( p4.getType() == p5.getType() );
  ufAssert( p5.getType() == p6.getType() );

  ufAssert( p4.getValue() == 1000 );
  ufAssert( p5.getValue() == 72 );
  ufAssert( p6.getValue() == 8 );
  ...
  auto ref4 = dynamic_cast<ARM_Const10_CoprocessorOffset &>( ref3 );
  ufAssert( ref4.getValue() == p5.getValue() );

  // Test the move constructors.
  ARM_Const10_CoprocessorOffset p7( std::move( p4 ) );
  ARM_Const10_CoprocessorOffset p8( std::move( p5 ) );
  ARM_Const10_CoprocessorOffset p9( std::move( p6 ) );

  ufAssert( p7.getType() == WIR_ParameterType::imm );
  ufAssert( p7.getType() == p8.getType() );
  ufAssert( p8.getType() == p9.getType() );

  ufAssert( p7.getValue() == 1000 );
  ufAssert( p8.getValue() == 72 );
  ufAssert( p9.getValue() == 8 );
  ...
  auto ref6 = dynamic_cast<ARM_Const10_CoprocessorOffset &>( ref5 );
  ufAssert( ref6.getValue() == p8.getValue() );

  // Test the copy assignment operator.
  ARM_Const10_CoprocessorOffset p10( 8 );
  p10 = p1;
  ARM_Const10_CoprocessorOffset p11( 16 );
  p11 = p2;
  ARM_Const10_CoprocessorOffset p12( 24 );
  p12 = p3;
  ...
  ufAssert( p10.getValue() == 1000 );
  ufAssert( p11.getValue() == 72 );
  ufAssert( p12.getValue() == 8 );
  ...
  auto ref8 = dynamic_cast<ARM_Const10_CoprocessorOffset &>( ref7 );
  ufAssert( ref8.getValue() == p10.getValue() );

  // Test the move assignment operator.
  ARM_Const10_CoprocessorOffset p13( 144 );
  p13 = std::move( p10 );
  ARM_Const10_CoprocessorOffset p14( 16 );
  p14 = std::move( p11 );
  ARM_Const10_CoprocessorOffset p15( 24 );
  p15 = std::move( p12 );
  ...
  ufAssert( p13.getValue() == 1000 );
  ufAssert( p14.getValue() == 72 );
  ufAssert( p15.getValue() == 8 );
  ...
  auto ref10 = dynamic_cast<ARM_Const10_CoprocessorOffset &>( ref9 );
  ufAssert( ref10.getValue() == p14.getValue() );

  // Check min/max unsigned value for 10 bits dividable by 4.
  ARM_Const10_CoprocessorOffset p16( 0 );
  ARM_Const10_CoprocessorOffset p17( 1020 );
