...
int main( void )
{
  ...
  ufAssert( uval( or1, 1 ).extract( 0, 4 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( or1, 1 ).extract( 4, 4 ).containsOnlyBit( WIR_L4::bL ) );
  ufAssert(
    uval( or1, 1 ).getLocation( 4 ).getRegisterParameter().getRegister() ==
      input4 );
  ufAssert( uval( or1, 1 ).getLocation( 4 ).getBitPosition() == 4 );
  ufAssert(
    uval( or1, 1 ).getLocation( 5 ).getRegisterParameter().getRegister() ==
      input4 );
  ufAssert( uval( or1, 1 ).getLocation( 5 ).getBitPosition() == 5 );
  ufAssert(
    uval( or1, 1 ).getLocation( 6 ).getRegisterParameter().getRegister() ==
      input4 );
  ufAssert( uval( or1, 1 ).getLocation( 6 ).getBitPosition() == 6 );
  ufAssert(
    uval( or1, 1 ).getLocation( 7 ).getRegisterParameter().getRegister() ==
      input4 );
  ufAssert( uval( or1, 1 ).getLocation( 7 ).getBitPosition() == 7 );
  ufAssert( uval( or1, 1 ).extract( 8, 4 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( or1, 1 ).extract( 12, 4 ).getSignedValue() == 4 );
  ufAssert( uval( or1, 1 ).extract( 16, 4 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( or1, 1 ).extract( 20, 4 ).getSignedValue() == 7 );
  ufAssert( uval( or1, 1 ).extract( 24, 8 ).containsOnlyBit( WIR_L4::bX ) );

  ufAssert( uval( or1, 2 ).extract( 0, 14 ).getSignedValue() == 3855 );
  ufAssert( uval( or1, 2 ).extract( 14, 1 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( or1, 2 ).extract( 15, 5 ).getSignedValue() == 30 );
  ufAssert( uval( or1, 2 ).extract( 20, 3 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( or1, 2 ).extract( 23, 1 ).containsOnlyBit( WIR_L4::b0 ) );
  ufAssert( uval( or1, 2 ).extract( 24, 8 ).containsOnlyBit( WIR_L4::bX ) );

  ufAssert( dval( or1, 0 ).extract( 0, 4 ).containsOnlyBit( WIR_L4::b1 ) );
  ufAssert( dval( or1, 0 ).extract( 4, 4 ).containsOnlyBit( WIR_L4::bL ) );
  ufAssert(
    dval( or1, 0 ).getLocation( 4 ).getRegisterParameter().getRegister() ==
      input4 );
  ufAssert( dval( or1, 0 ).getLocation( 4 ).getBitPosition() == 4 );
  ufAssert(
    dval( or1, 0 ).getLocation( 5 ).getRegisterParameter().getRegister() ==
      input4 );
  ufAssert( dval( or1, 0 ).getLocation( 5 ).getBitPosition() == 5 );
  ufAssert(
    dval( or1, 0 ).getLocation( 6 ).getRegisterParameter().getRegister() ==
      input4 );
  ufAssert( dval( or1, 0 ).getLocation( 6 ).getBitPosition() == 6 );
  ufAssert(
    dval( or1, 0 ).getLocation( 7 ).getRegisterParameter().getRegister() ==
      input4 );
  ufAssert( dval( or1, 0 ).getLocation( 7 ).getBitPosition() == 7 );
  ufAssert( dval( or1, 0 ).extract( 8, 24 ).getSignedValue() == 4161359 );
