...
Retrieving the most recent state of the \gls{WIR} software from Git is done easiest by recursively cloning its public repository as shown in \cref{lst:git}.

\begin{lstlisting}[style=commandline,float=h,caption={Cloning of the Public Git Repository},label=lst:git]
@/tmp/WIR@> git clone --recurse-submodules https://github.com/TUHH-IES/WIR
Cloning into 'WIR'...
...
remote: Total 1362 (delta 690), reused 1354 (delta 682), pack-reused 0 (from 0)
Receiving objects: 100% (1362/1362), 28.44 MiB Ü\verb+|+Ü 11.99 MiB/s, done.
Resolving deltas: 100% (690/690), done.
Submodule 'LIBUSEFUL' (https://github.com/TUHH-IES/LIBUSEFUL) registered for path 'LIBUSEFUL'
Cloning into '/tmp/WIR/LIBUSEFUL'...
remote: Enumerating objects: 65, done.
remote: Counting objects: 100% (65/65), done.
remote: Compressing objects: 100% (50/50), done.
remote: Total 65 (delta 20), reused 57 (delta 12), pack-reused 0 (from 0)
Receiving objects: 100% (65/65), 55.73 KiB Ü\verb+|+Ü 2.79 MiB/s, done.
Resolving deltas: 100% (20/20), done.
Submodule path 'LIBUSEFUL': checked out 'd0aa3ccdd71572c5bb32dbad09a0966a46645e5a'
\end{lstlisting}

\cref{fig:wircodedirectory} depicts the overall directory structure of the \gls{WIR} software package.
The top-level directory \texttt{WIR} contains a couple of files specifying authors having contributed to the software, a citation file, the license from \cref{sec:license}, a brief readme file, and the documentation about the major release versions of \gls{WIR}.
