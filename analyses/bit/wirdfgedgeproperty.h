  ...
  public:
    ...
    /*!
      ...
      @param[in] t A const reference to a %WIR register parameter denoting the
                   edge's target.
      @param[in] d A reference to the DFG instance to which an edge belongs.
    ...
    */
    WIR_DFGEdgeProperty( const WIR_RegisterParameter &,
                         const WIR_RegisterParameter &, WIR_DFG & );
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    WIR_DFGEdgeProperty( const WIR_BaseImmediateParameter &, WIR_DFG & );
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    WIR_DFGEdgeProperty( const WIR_RegisterParameter &, WIR_DFG & );
