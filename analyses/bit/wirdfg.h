...
class WIR_DFG
{
  ...
  public:
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    explicit WIR_DFG( WIR_Function &, bool = false, bool = false );
    ...
    */
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    long long getDistance( const WIR_Operation &, const WIR_Operation & );
  ...
  protected:
    ...
    */
    ...
    /*!
      @brief mNodeDistancesComputed stores the IDs of all those %WIR operations
             for which the distances to other operations in the DFG have already
             been computed.

      The distance between two DFG nodes is defined as the minimum number of
      edges along the shortest path from the first to the second node.
    */
    std::set<WIR_id_t> mNodeDistancesComputed;
