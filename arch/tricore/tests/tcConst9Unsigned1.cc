...
int main( void )
{
  ...
  TC_Const9_Unsigned p1( 0 );
  TC_Const9_Unsigned p2( 12 );
  TC_Const9_Unsigned p3( 27 );
  ...
  auto ref2 = dynamic_cast<TC_Const9_Unsigned &>( ref1 );
  ufAssert( ref2.getValue() == p1.getValue() );

  // Test the copy constructors.
  TC_Const9_Unsigned p4( p1 );
  TC_Const9_Unsigned p5( p2 );
  TC_Const9_Unsigned p6( p3 );
  ...
  auto ref4 = dynamic_cast<TC_Const9_Unsigned &>( ref3 );
  ufAssert( ref4.getValue() == p5.getValue() );

  // Test the move constructors.
  TC_Const9_Unsigned p7( std::move( p4 ) );
  TC_Const9_Unsigned p8( std::move( p5 ) );
  TC_Const9_Unsigned p9( std::move( p6 ) );
  ...
  auto ref6 = dynamic_cast<TC_Const9_Unsigned &>( ref5 );
  ufAssert( ref6.getValue() == p8.getValue() );

  // Test the copy assignment operator.
  TC_Const9_Unsigned p10( 8 );
  p10 = p1;
  TC_Const9_Unsigned p11( 16 );
  p11 = p2;
  TC_Const9_Unsigned p12( 24 );
  p12 = p3;
  ...
  auto ref8 = dynamic_cast<TC_Const9_Unsigned &>( ref7 );
  ufAssert( ref8.getValue() == p10.getValue() );

  // Test the move assignment operator.
  TC_Const9_Unsigned p13( 7 );
  p13 = std::move( p10 );
  TC_Const9_Unsigned p14( 14 );
  p14 = std::move( p11 );
  TC_Const9_Unsigned p15( 21 );
  p15 = std::move( p12 );
  ...
  auto ref10 = dynamic_cast<TC_Const9_Unsigned &>( ref9 );
  ufAssert( ref10.getValue() == p14.getValue() );

  // Check min/max unsigned value for 9 bits.
  TC_Const9_Unsigned p16( 0 );
  TC_Const9_Unsigned p17( 511 );
