...
class WIR_Container_API
{
  ...
  public:
    ...
    */
    ...
    /*!
      ...
      @param[in] c A const reference to the container to be removed.

      This destroys the removed container.

      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    void eraseContainer( const WIR_BaseContainer & );
  ...
  private:
    ...
    /*!
      @brief WIR_CompareContainer is a comparator class that is used to sort
             sets of %WIR containers uniquely.

      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    struct WIR_CompareContainer
    {
      inline bool operator()( const std::unique_ptr<WIR_BaseContainer> &lhs,
                              const std::unique_ptr<WIR_BaseContainer> &rhs ) const
      {
    ...
    */
    std::map<WIR_id_t,
             std::set<std::unique_ptr<WIR_BaseContainer>, WIR_CompareContainer>> mContainerPointers;
