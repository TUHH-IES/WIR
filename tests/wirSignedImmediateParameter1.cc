...
int main( void )
{
  ...
  MIPS_Immediate16_Signed p1( 42 );
  MIPS_Immediate16_Signed p2( 4711 );
  MIPS_Immediate16_Signed p3( 0x815 );
  ...
  MIPS_Immediate16_Signed p10( 123 );
  p10 = p1;
  MIPS_Immediate16_Signed p11( 456 );
  p11 = p2;
  MIPS_Immediate16_Signed p12( 789 );
  p12 = p3;
  ...
  MIPS_Immediate16_Signed p13( 321 );
  p13 = std::move( p10 );
  MIPS_Immediate16_Signed p14( 654 );
  p14 = std::move( p11 );
  MIPS_Immediate16_Signed p15( 987 );
  p15 = std::move( p12 );
