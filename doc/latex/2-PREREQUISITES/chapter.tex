...
Should it have to be re-generated from its source files, a full installation of \texttt{pdflatex} is required, including all standard packages (e.g., KOMA), the bibliography infrastructure \texttt{biblatex} and \texttt{biber}, as well as the glossary generator \texttt{makeglossaries}.
