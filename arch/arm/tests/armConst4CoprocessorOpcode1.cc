...
int main( void )
{
  ...
  ARM_Const4_CoprocessorOpcode p1( 0 );
  ARM_Const4_CoprocessorOpcode p2( 5 );
  ARM_Const4_CoprocessorOpcode p3( 2 );
  ...
  auto ref2 = dynamic_cast<ARM_Const4_CoprocessorOpcode &>( ref1 );
  ufAssert( ref2.getValue() == p1.getValue() );

  // Test the copy constructors.
  ARM_Const4_CoprocessorOpcode p4( p1 );
  ARM_Const4_CoprocessorOpcode p5( p2 );
  ARM_Const4_CoprocessorOpcode p6( p3 );
  ...
  auto ref4 = dynamic_cast<ARM_Const4_CoprocessorOpcode &>( ref3 );
  ufAssert( ref4.getValue() == p5.getValue() );

  // Test the move constructors.
  ARM_Const4_CoprocessorOpcode p7( std::move( p4 ) );
  ARM_Const4_CoprocessorOpcode p8( std::move( p5 ) );
  ARM_Const4_CoprocessorOpcode p9( std::move( p6 ) );
  ...
  auto ref6 = dynamic_cast<ARM_Const4_CoprocessorOpcode &>( ref5 );
  ufAssert( ref6.getValue() == p8.getValue() );

  // Test the copy assignment operator.
  ARM_Const4_CoprocessorOpcode p10( 1 );
  p10 = p1;
  ARM_Const4_CoprocessorOpcode p11( 2 );
  p11 = p2;
  ARM_Const4_CoprocessorOpcode p12( 3 );
  p12 = p3;
  ...
  auto ref8 = dynamic_cast<ARM_Const4_CoprocessorOpcode &>( ref7 );
  ufAssert( ref8.getValue() == p10.getValue() );

  // Test the move assignment operator.
  ARM_Const4_CoprocessorOpcode p13( 7 );
  p13 = std::move( p10 );
  ARM_Const4_CoprocessorOpcode p14( 6 );
  p14 = std::move( p11 );
  ARM_Const4_CoprocessorOpcode p15( 5 );
  p15 = std::move( p12 );
  ...
  auto ref10 = dynamic_cast<ARM_Const4_CoprocessorOpcode &>( ref9 );
  ufAssert( ref10.getValue() == p14.getValue() );

  // Check min/max unsigned value for 4 bits.
  ARM_Const4_CoprocessorOpcode p16( 0 );
  ARM_Const4_CoprocessorOpcode p17( 15 );
