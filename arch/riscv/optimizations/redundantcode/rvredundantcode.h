...
#ifndef _RV_REDUNDANTCODE_H
#define _RV_REDUNDANTCODE_H
...
/*!
  @brief Class RV_RedundantCode is a RISC-V-specific optimization that removes
         redundant code that computes bit-wise equivalent results from %WIR
         functions.

  @author Heiko Falk <Heiko.Falk@tuhh.de>
*/
class RV_RedundantCode final : public WIR_RedundantCode
{
  ...
  public:
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    explicit RV_RedundantCode( WIR_System & );
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    explicit RV_RedundantCode( WIR_CompilationUnit & );
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    explicit RV_RedundantCode( WIR_Function & );

    /*!
      @brief Destructor.
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    virtual ~RV_RedundantCode( void );
    ...
    */
    ...
    /*!
      ...
      @return true iff the involved register parameters and their bit-values are
              suited for redundant code elimination for the RISC-V architecture,
              false otherwise.
      ...
      Furthermore, the obeyance of particular RISC-V operation formats that
      require the presence of particular physical registers is ensured.
