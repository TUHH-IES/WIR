...
void TC131::init( void )
{
  ...
  registerOpCode( OpCode::CACHEI_W, OperationFormat::AC10BOA );
  registerOpCode( OpCode::CACHEI_W, OperationFormat::AC10PIA );
  registerOpCode( OpCode::CACHEI_WI, OperationFormat::AC10BOA );
  registerOpCode( OpCode::CACHEI_WI, OperationFormat::AC10PIA );
  registerOpCode( OpCode::FTOIZ, OperationFormat::DD );
  registerOpCode( OpCode::FTOQ31Z, OperationFormat::DDD_1 );
  registerOpCode( OpCode::FTOUZ, OperationFormat::DD );
