                               ...
                               public WIR_HierarchicalCFG
{
  ...
  public:
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    explicit WIR_StructuralAnalysis( WIR_Function &, bool = false,
                                     bool = false );
  ...
  private:
    ...
    */
    ...
    /*!
      @brief checkIfElseWhileLoop checks whether the specified CFG node forms an
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    WIR_WhileLoopTreeNode *checkIfElseWhileLoop( const WIR_ControlTreeNode &,
                                                 WIR_HierarchicalCFG::WIR_HCFGNodeSet & );
    ...
    */
    ...
    /*!
      @brief checkProperSwitch checks whether the specified CFG node forms an
             acyclic switch-case region whose condition is a proper region.
      ...
      nodes test1 ... testn-1. After that, this proper node will form the
      condition node of a switch-case region, whose cases will be nodes case1
      ... casen.

      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    WIR_SwitchCaseTreeNode *checkProperSwitch( const WIR_ControlTreeNode &,
                                               WIR_HierarchicalCFG::WIR_HCFGNodeSet & );
    ...
    */
    ...
    /*!
      ...
      @param[in] node A const reference to a CFG node to be examined.
      @param[in] nSet A const reference to a set of hierarchical CFG nodes
                      contained in a cyclic control region.
      @return A pointer to a newly created self-loop region node if such a
              region was detected, or nullptr otherwise.
    ...
    */
    WIR_SelfLoopTreeNode *checkSelfLoop( const WIR_ControlTreeNode &,
                                         const WIR_HierarchicalCFG::WIR_HCFGNodeSet & ) const;
    ...
    */
    ...
    /*!
      @brief testProperSwitchStart tests whether the specified CFG node forms
             the start of an acyclic switch-case region whose condition will be
             a proper region.

      @param[in] node A const reference to a CFG node to be examined.
      @param[in,out] testNodes A reference to a set of hierarchical CFG nodes
                               being the test nodes of the potential
                               switch-case.
      @param[in,out] caseNodes A reference to a set of hierarchical CFG nodes
                               being the cases of the potential switch-case.
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    bool testProperSwitchStart( const WIR_ControlTreeNode &,
                                WIR_HierarchicalCFG::WIR_HCFGNodeSet &,
                                WIR_HierarchicalCFG::WIR_HCFGNodeSet & );

    /*!
      @brief testProperSwitchMiddle tests whether the specified CFG node forms
             some middle part of an acyclic switch-case region whose condition
             will be a proper region.
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    bool testProperSwitchMiddle( const WIR_ControlTreeNode &,
                                 WIR_HierarchicalCFG::WIR_HCFGNodeSet &,
                                 WIR_HierarchicalCFG::WIR_HCFGNodeSet & );

    /*!
      @brief testProperSwitchEnd tests whether the specified CFG node forms some
             end of an acyclic switch-case region whose condition will be a
             proper region.
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    bool testProperSwitchEnd( const WIR_ControlTreeNode &,
                              WIR_HierarchicalCFG::WIR_HCFGNodeSet &,
                              WIR_HierarchicalCFG::WIR_HCFGNodeSet & );
    ...
    */
    ...
    /*!
      @brief mCheckProperSwitchRegions stores whether checks for proper acyclic
             switch regions shall be performed or not.
    */
    bool mCheckProperSwitchRegions;
