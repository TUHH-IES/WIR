...
int main( void )
{
  ...
  MIPS_Immediate16_Signed p1( 0 );
  MIPS_Immediate16_Signed p2( 1 );
  MIPS_Immediate16_Signed p3( -3 );
  ...
  ufAssert( p3.getValue() == -3 );

  p1.setValue( -2 );
  p2.setValue( 2 );
  p3.setValue( 7 );

  ufAssert( p1.getValue() == -2 );
  ...
  auto ref4 = dynamic_cast<MIPS_Immediate16_Signed &>( ref3 );
  ufAssert( ref4.getValue() == p5.getValue() );

  // Test the move constructors.
  MIPS_Immediate16_Signed p7( std::move( p4 ) );
  MIPS_Immediate16_Signed p8( std::move( p5 ) );
  MIPS_Immediate16_Signed p9( std::move( p6 ) );

  ufAssert( p7.getType() == WIR_ParameterType::imm );
  ufAssert( p7.getType() == p8.getType() );
  ufAssert( p8.getType() == p9.getType() );

  ufAssert( p7.getValue() == -2 );
  ...
  auto ref6 = dynamic_cast<MIPS_Immediate16_Signed &>( ref5 );
  ufAssert( ref6.getValue() == p8.getValue() );

  // Test the copy assignment operator.
  MIPS_Immediate16_Signed p10( -8 );
  p10 = p1;
  MIPS_Immediate16_Signed p11( -3 );
  p11 = p2;
  MIPS_Immediate16_Signed p12( 4 );
  p12 = p3;
  ...
  auto ref8 = dynamic_cast<MIPS_Immediate16_Signed &>( ref7 );
  ufAssert( ref8.getValue() == p10.getValue() );

  // Test the move assignment operator.
  MIPS_Immediate16_Signed p13( -8 );
  p13 = std::move( p10 );
  MIPS_Immediate16_Signed p14( -3 );
  p14 = std::move( p11 );
  MIPS_Immediate16_Signed p15( 4 );
  p15 = std::move( p12 );
  ...
  auto ref10 = dynamic_cast<MIPS_Immediate16_Signed &>( ref9 );
  ufAssert( ref10.getValue() == p14.getValue() );

  // Check min/max signed values for 16 bits.
  MIPS_Immediate16_Signed p16( -32768 );
  MIPS_Immediate16_Signed p17( 32767 );
