...
int main( void )
{
  ...
  ufAssert( dval( cadd1, 0 ).getSignedValue() == -123 );
  ufAssert( uval( cadd1, 1 ).isBinaryInteger() );
  ufAssert( uval( cadd1, 2 ).extract( 28, 4 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( cadd1, 2 ).extract( 24, 4 ).isBinaryInteger() );
  ufAssert( uval( cadd1, 2 ).extract( 15, 9 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( cadd1, 2 ).extract( 0, 15 ).isBinaryInteger() );
  ufAssert( uval( cadd1, 3 ).isBinaryInteger() );

  ufAssert( dval( cadd2, 0 ).getSignedValue() == -59 );
  ufAssert( uval( cadd2, 1 ).isBinaryInteger() );
  ufAssert( uval( cadd2, 2 ).extract( 28, 4 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( cadd2, 2 ).extract( 0, 28 ).isBinaryInteger() );
  ufAssert( uval( cadd2, 3 ).extract( 28, 4 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( cadd2, 3 ).extract( 0, 28 ).isBinaryInteger() );

  ufAssert( dval( cadd3, 0 ).containsOnlyBit( WIR_L4::bL ) );

  ufAssert( dval( caddn1, 0 ).getSignedValue() == -59 );
  ufAssert( uval( caddn1, 1 ).isBinaryInteger() );
  ufAssert( uval( caddn1, 2 ).extract( 28, 4 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( caddn1, 2 ).extract( 0, 28 ).isBinaryInteger() );
  ufAssert( uval( caddn1, 3 ).extract( 28, 4 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( caddn1, 3 ).extract( 0, 28 ).isBinaryInteger() );

  ufAssert( dval( caddn2, 0 ).getSignedValue() == -123 );
  ufAssert( uval( caddn2, 1 ).isBinaryInteger() );
  ufAssert( uval( caddn2, 2 ).extract( 28, 4 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( caddn2, 2 ).extract( 24, 4 ).isBinaryInteger() );
  ufAssert( uval( caddn2, 2 ).extract( 15, 9 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( caddn2, 2 ).extract( 0, 15 ).isBinaryInteger() );
  ufAssert( uval( caddn2, 3 ).isBinaryInteger() );

  ufAssert( dval( caddn3, 0 ).containsOnlyBit( WIR_L4::bL ) );
