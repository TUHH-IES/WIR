...
class WIR_Registry
{
  ...
  public:
    ...
    */
    ...
    /*!
      @brief registerLdScriptBetweenSectionDumper registers a function pointer
             for a processor-specific in-between section linker script I/O
             function under the numerical ID of some processor architecture.

      @param[in] id A processor architecture's unique numerical identifier.
      @param[in] f A pointer to a processor-specific I/O function for sections
                   within linker scripts.

      registerLdScriptBetweenSectionDumper shall be called by the init methods
      of class WIR_Processor in order to setup processor-specific I/O routines.
    ...
    */
    ...
    /*!
      @brief getLdScriptBetweenSectionDumper returns a pointer to a
             processor-specific in-between section linker script I/O function
      ...
      @author Shashank Jadhav <Shashank.Jadhav@tuhh.de>
    */
    static WIR_LdScriptBetweenSectionDumper getLdScriptBetweenSectionDumper( unsigned int );
  ...
  private:
    ...
    */
    static std::map<std::string,
                    std::unique_ptr<WIR_BaseProcessor>> mProcessorMap;
    ...
    */
    static std::map<unsigned int,
                    WIR_CompilationUnitDumper> mCompilationUnitDumperMap;
    ...
    */
    static std::map<unsigned int,
                    WIR_AddressingModeParameterDumper> mAddressingModeParameterDumperMap;
    ...
    */
    static std::map<unsigned int,
                    WIR_ConditionFieldParameterDumper> mConditionFieldParameterDumperMap;
    ...
    */
    static std::map<unsigned int,
                    WIR_ImmediateParameterDumper> mImmediateParameterDumperMap;
    ...
    */
    static std::map<unsigned int,
                    WIR_LabelParameterDumper> mLabelParameterDumperMap;
    ...
    */
    static std::map<unsigned int,
                    WIR_LdScriptSectionDumper> mLdScriptSectionDumperMap;

    /*!
      @brief mLdScriptBetweenSectionDumperMap maps the numerical ID of a
             processor architecture to a function pointer for a
             processor-specific in-between section linker script I/O function.
    */
    static std::map<unsigned int,
                    WIR_LdScriptBetweenSectionDumper> mLdScriptBetweenSectionDumperMap;
    ...
    */
    static std::map<unsigned int,
                    WIR_RegisterParameterDumper> mRegisterParameterDumperMap;
