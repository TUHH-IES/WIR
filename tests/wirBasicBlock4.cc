...
int main( void )
{
  ...
  // Retrieve all successor/predecessor sets.
  ...
  ufAssert( ( pred3.size() == 1 ) && pred3.count( b2 ) );
  ufAssert( ( pred4.size() == 1 ) && pred4.count( b3 ) );
