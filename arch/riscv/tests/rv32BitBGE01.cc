...
int main( void )
{
  ...
  rv32op(
    { RV32I::OpCode::LUI, RV32I::OperationFormat::RC20_1,
      ...
      new RV_Const20_Unsigned( 560296 ) } );
  rv32op(
  ...
  ufAssert( uval( bge1, 0 ).extract( 0, 31 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( bge1, 0 ).extract( 31, 1 ).containsOnlyBit( WIR_L4::b0 ) );

  ufAssert( uval( bge1, 1 ).extract( 0, 31 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( bge1, 1 ).extract( 31, 1 ).containsOnlyBit( WIR_L4::b1 ) );
