...
class WIR_GenericImmediateParameter : public WIR_BaseImmediateParameter
{
  ...
  public:
    ...
    */
    ...
    {
      DSTART(
        "WIR_GenericImmediateParameter<DerivedClass, "
        "Signed>::WIR_GenericImmediateParameter(unsigned int)" );
    };
    ...
    */
      ...
      WIR_BaseImmediateParameter( __o )
    {
      DSTART(
        "WIR_GenericImmediateParameter<DerivedClass, "
        "Signed>::WIR_GenericImmediateParameter(const "
        "WIR_GenericImmediateParameter<DerivedClass, Signed>&)" );
    };
    ...
    */
      ...
      WIR_BaseImmediateParameter( std::move( __o ) )
    {
      DSTART(
        "WIR_GenericImmediateParameter<DerivedClass, "
        "Signed>::WIR_GenericImmediateParameter(WIR_GenericImmediateParameter<"
        "DerivedClass, Signed>&&)" );
    };
    ...
    */
    virtual ~WIR_GenericImmediateParameter( void )
    {
      DSTART(
        "WIR_GenericImmediateParameter<DerivedClass, "
        "Signed>::~WIR_GenericImmediateParameter() " );
    };
    ...
    */
    WIR_GenericImmediateParameter & operator = ( const WIR_GenericImmediateParameter &__o )
    {
      DSTART(
        "WIR_GenericImmediateParameter<DerivedClass, Signed>& "
        "WIR_GenericImmediateParameter<DerivedClass, Signed>::operator=(const "
        "WIR_GenericImmediateParameter<DerivedClass, Signed>&)" );
    ...
    */
    WIR_GenericImmediateParameter & operator = ( WIR_GenericImmediateParameter &&__o )
    {
      DSTART(
        "WIR_GenericImmediateParameter<DerivedClass, Signed>& "
        "WIR_GenericImmediateParameter<DerivedClass, "
        "Signed>::operator=(WIR_GenericImmediateParameter<DerivedClass, "
        "Signed>&&)" );
    ...
    */
    ...
    {
      DSTART(
        "bool WIR_GenericImmediateParameter<DerivedClass, Signed>::isSigned() "
        "const" );
  ...
  public:
    ...
    */
      ...
      mValue { 0 }
    {
      ...
      WIR_ImmediateParameter::setValue( __i );
    };
    ...
    */
      ...
      mValue { __o.mValue }
    {
      DSTART(
        "WIR_ImmediateParameter<DerivedClass, true>::WIR_ImmediateParameter("
        "const WIR_ImmediateParameter<DerivedClass, true>&)" );
    };
    ...
    */
    ...
    {
      DSTART(
        "WIR_ImmediateParameter<DerivedClass, "
        "true>::WIR_ImmediateParameter(WIR_ImmediateParameter<DerivedClass, "
        "true>&&)" );
    ...
    */
    ...
    {
      DSTART(
        "DerivedClass& WIR_ImmediateParameter<DerivedClass, "
        "true>::operator=(const DerivedClass&)" );
    ...
    */
    ...
    {
      DSTART(
        "void WIR_ImmediateParameter<DerivedClass, true>::setValue("
        "long long int)" );
    ...
    */
    ...
    {
      DSTART(
        "long long int WIR_ImmediateParameter<DerivedClass, true>::getValue() "
        "const" );
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    virtual signed long long getSignedValue( void ) const override
    {
      DSTART(
        "long long int WIR_ImmediateParameter<DerivedClass, "
        "true>::getSignedValue() const" );
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    virtual unsigned long long getUnsignedValue( void ) const override
    {
std::cout << BOOST_CURRENT_FUNCTION << std::endl;
    ...
    */
    ...
    {
      DSTART(
        "static long long int WIR_ImmediateParameter<DerivedClass, "
        "true>::getMinValue(unsigned int)" );
    ...
    */
    ...
    {
      DSTART(
        "string WIR_ImmediateParameter<DerivedClass, "
        "true>::getValueString() const" );
  ...
  private:
    ...
    */
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    virtual WIR_BaseImmediateParameter *clone( void ) const override
    {
std::cout << BOOST_CURRENT_FUNCTION << std::endl;
      DSTART( BOOST_CURRENT_FUNCTION );
  ...
  public:
    ...
    */
      ...
      mValue { __o.mValue }
    {
      DSTART(
        "WIR_ImmediateParameter<DerivedClass, false>::WIR_ImmediateParameter("
        "const WIR_ImmediateParameter<DerivedClass, false>&)" );
    };
    ...
    */
      ...
      mValue { std::move( __o.mValue ) }
    {
      DSTART(
        "WIR_ImmediateParameter<DerivedClass, "
        "false>::WIR_ImmediateParameter(WIR_ImmediateParameter<DerivedClass, "
        "false>&&)" );
    ...
    */
    ...
    {
      DSTART(
        "DerivedClass& WIR_ImmediateParameter<DerivedClass, false>::operator=("
        "const DerivedClass&) " );
    ...
    */
    ...
    {
      DSTART(
        "void WIR_ImmediateParameter<DerivedClass, false>::setValue(long long "
        "unsigned int)" );
    ...
    */
    ...
    {
      DSTART(
        "long long unsigned int WIR_ImmediateParameter<DerivedClass, "
        "false>::getValue() const" );
    ...
    */
    ...
    {
      DSTART(
        "static long long unsigned int WIR_ImmediateParameter<DerivedClass, "
        "false>::getMaxValue(unsigned int)" );
    ...
    */
    ...
    {
      DSTART(
        "string WIR_ImmediateParameter<DerivedClass, false>::getValueString() "
        "const" );
