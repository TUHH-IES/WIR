...
int main( void )
{
  ...
  RV_Const10_Unsigned p1( 4 );
  RV_Const10_Unsigned p2( 8 );
  RV_Const10_Unsigned p3( 16 );
  ...
  auto ref2 = dynamic_cast<RV_Const10_Unsigned &>( ref1 );
  ufAssert( ref2.getValue() == p1.getValue() );

  // Test the copy constructors.
  RV_Const10_Unsigned p4( p1 );
  RV_Const10_Unsigned p5( p2 );
  RV_Const10_Unsigned p6( p3 );

  ufAssert( p4.getType() == WIR_ParameterType::imm );
  ufAssert( p4.getType() == p5.getType() );
  ufAssert( p5.getType() == p6.getType() );

  ufAssert( p4.getValue() == 12 );
  ufAssert( p5.getValue() == 20 );
  ...
  auto ref4 = dynamic_cast<RV_Const10_Unsigned &>( ref3 );
  ufAssert( ref4.getValue() == p5.getValue() );

  // Test the move constructors.
  RV_Const10_Unsigned p7( std::move( p4 ) );
  RV_Const10_Unsigned p8( std::move( p5 ) );
  RV_Const10_Unsigned p9( std::move( p6 ) );

  ufAssert( p7.getType() == WIR_ParameterType::imm );
  ufAssert( p7.getType() == p8.getType() );
  ufAssert( p8.getType() == p9.getType() );

  ufAssert( p7.getValue() == 12 );
  ufAssert( p8.getValue() == 20 );
  ...
  auto ref6 = dynamic_cast<RV_Const10_Unsigned &>( ref5 );
  ufAssert( ref6.getValue() == p8.getValue() );

  // Test the copy assignment operator.
  RV_Const10_Unsigned p10( 8 );
  p10 = p1;
  RV_Const10_Unsigned p11( 16 );
  p11 = p2;
  RV_Const10_Unsigned p12( 24 );
  p12 = p3;
  ...
  ufAssert( p10.getValue() == 12 );
  ufAssert( p11.getValue() == 20 );
  ...
  auto ref8 = dynamic_cast<RV_Const10_Unsigned &>( ref7 );
  ufAssert( ref8.getValue() == p10.getValue() );

  // Test the move assignment operator.
  RV_Const10_Unsigned p13( 8 );
  p13 = std::move( p10 );
  RV_Const10_Unsigned p14( 12 );
  p14 = std::move( p11 );
  RV_Const10_Unsigned p15( 16 );
  p15 = std::move( p12 );
  ...
  ufAssert( p13.getValue() == 12 );
  ufAssert( p14.getValue() == 20 );
  ...
  auto ref10 = dynamic_cast<RV_Const10_Unsigned &>( ref9 );
  ufAssert( ref10.getValue() == p14.getValue() );

  // Check min/max unsigned value for 10 bits.
  RV_Const10_Unsigned p16( 4 );
  RV_Const10_Unsigned p17( 1020 );
