...
int main( void )
{
  ...
  ARM_Const5_RotateAmount p1( 0 );
  ARM_Const5_RotateAmount p2( 12 );
  ARM_Const5_RotateAmount p3( 28 );
  ...
  ufAssert( p3.getValue() == 28 );

  p1.setValue( 22 );
  p2.setValue( 18 );
  p3.setValue( 6 );

  ufAssert( p1.getValue() == 22 );
  ufAssert( p2.getValue() == 18 );
  ufAssert( p3.getValue() == 6 );

  ufAssert( !p1.isSigned() );
  ufAssert( p1.isUnsigned() );
  ufAssert( p1.getBitWidth() == 5 );
  ...
  auto ref2 = dynamic_cast<ARM_Const5_RotateAmount &>( ref1 );
  ufAssert( ref2.getValue() == p1.getValue() );

  // Test the copy constructors.
  ARM_Const5_RotateAmount p4( p1 );
  ARM_Const5_RotateAmount p5( p2 );
  ARM_Const5_RotateAmount p6( p3 );

  ufAssert( p4.getType() == WIR_ParameterType::imm );
  ufAssert( p4.getType() == p5.getType() );
  ufAssert( p5.getType() == p6.getType() );

  ufAssert( p4.getValue() == 22 );
  ufAssert( p5.getValue() == 18 );
  ufAssert( p6.getValue() == 6 );

  ufAssert( !p4.isSigned() );
  ufAssert( p4.isUnsigned() );
  ufAssert( p4.getBitWidth() == 5 );
  ...
  auto ref4 = dynamic_cast<ARM_Const5_RotateAmount &>( ref3 );
  ufAssert( ref4.getValue() == p5.getValue() );

  // Test the move constructors.
  ARM_Const5_RotateAmount p7( std::move( p4 ) );
  ARM_Const5_RotateAmount p8( std::move( p5 ) );
  ARM_Const5_RotateAmount p9( std::move( p6 ) );

  ufAssert( p7.getType() == WIR_ParameterType::imm );
  ufAssert( p7.getType() == p8.getType() );
  ufAssert( p8.getType() == p9.getType() );

  ufAssert( p7.getValue() == 22 );
  ufAssert( p8.getValue() == 18 );
  ufAssert( p9.getValue() == 6 );
  ...
  auto ref6 = dynamic_cast<ARM_Const5_RotateAmount &>( ref5 );
  ufAssert( ref6.getValue() == p8.getValue() );

  // Test the copy assignment operator.
  ARM_Const5_RotateAmount p10( 8 );
  p10 = p1;
  ARM_Const5_RotateAmount p11( 16 );
  p11 = p2;
  ARM_Const5_RotateAmount p12( 24 );
  p12 = p3;
  ...
  ufAssert( p10.getValue() == 22 );
  ufAssert( p11.getValue() == 18 );
  ufAssert( p12.getValue() == 6 );

  ufAssert( !p10.isSigned() );
  ufAssert( p10.isUnsigned() );
  ufAssert( p10.getBitWidth() == 5 );
  ...
  auto ref8 = dynamic_cast<ARM_Const5_RotateAmount &>( ref7 );
  ufAssert( ref8.getValue() == p10.getValue() );

  // Test the move assignment operator.
  ARM_Const5_RotateAmount p13( 10 );
  p13 = std::move( p10 );
  ARM_Const5_RotateAmount p14( 20 );
  p14 = std::move( p11 );
  ARM_Const5_RotateAmount p15( 24 );
  p15 = std::move( p12 );
  ...
  ufAssert( p13.getValue() == 22 );
  ufAssert( p14.getValue() == 18 );
  ufAssert( p15.getValue() == 6 );
  ...
  auto ref10 = dynamic_cast<ARM_Const5_RotateAmount &>( ref9 );
  ufAssert( ref10.getValue() == p14.getValue() );

  // Check min/max unsigned value for 5 bits.
  ARM_Const5_RotateAmount p16( 0 );
  ARM_Const5_RotateAmount p17( 30 );
