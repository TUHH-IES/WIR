...
int main( void )
{
  ...
  ufAssert( dval( cli1, 0 ).isBinaryInteger() );
  ufAssert( dval( cli1, 0 ).extract( 0, 32 ).getSignedValue() == 31 );

  ufAssert( dval( cli2, 0 ).isBinaryInteger() );
  ufAssert( dval( cli2, 0 ).extract( 0, 32 ).getSignedValue() == -16 );
