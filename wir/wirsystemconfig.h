...
/*!
  ...
  -# Each paragraph must contain a specification of the component's type: <br />
     <tt>type = { bus | cache | core | memory | section | system }</tt> <br />
  ...
  -# For <tt>type = system</tt>:
     -# Only the name of a system has to be specified unambiguously, no other
        directives can be specified for systems.
