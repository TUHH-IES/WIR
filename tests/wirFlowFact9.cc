...
int main( void )
{
  ...
  WIR_FlowRestriction fr2 { std::move( leq ), std::move( geq ) };
  ...
  ufAssert( fr_copy.isPartOfLHS( bc1 ) == true );
  ufAssert( fr_copy.isPartOfLHS( bc2 ) == true );
  ufAssert( fr_copy.isPartOfRHS( bc3 ) == true );
