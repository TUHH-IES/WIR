...
class WIR_UpDownValue
{
  ...
  public:
    ...
    */
    ...
    /*!
      ...
      @return true if the up/down value is either unsigned or if it is a signed
              integer whose most-significant bit is '0'.
    ...
    */
    ...
    /*!
      ...
      multiplication, extended to the partial order L4. It asserts if up/down
      values of different bit widths are combined.

      @author Dania Alghazal <Dania.Al.Ghazal@tuhh.de>
    */
    WIR_UpDownValue operator * ( const WIR_UpDownValue & ) const;
    ...
    /*!
      ...
      @param[in] __o A const reference to another up/down value denoting the
                     divisor.
      @return The up/down value resulting from the division.

      This operator bases on a restoring division (D. Kumar, P. Saha, A.
      Dandapat. Hardware implementation of methodologies of fixed point division
      algorithms. Intl. Journal on Smart Sensing and Intelligent Systems vol.
      10(3), 2017.) extended to signed values in the partial order L4. It
      asserts if up/down values of different bit widths are combined.
  ...
  private:
    ...
    */
    ...
    /*!
      @brief restoringDivision performs a bitwise division of two up/down
             values.
      ...
      This method implements a restoring division (D. Kumar, P. Saha, A.
      Dandapat. Hardware implementation of methodologies of fixed point division
      algorithms. Intl. Journal on Smart Sensing and Intelligent Systems vol.
      10(3), 2017.) extended to signed values in the partial order L4. It
      asserts if up/down values of different bit widths are combined.
      ...
      @author Dania Alghazal <Dania.Al.Ghazal@tuhh.de>
    */
    WIR_UpDownValue restoringDivision( const WIR_UpDownValue & ) const;
