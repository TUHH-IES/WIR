...
int main( void )
{
  ...
  ufAssert( uval( cmv1, 1 ).extract( 0, 29 ).getSignedValue() == 31 );
  ufAssert( uval( cmv1, 1 ).extract( 29, 3 ).containsOnlyBit( WIR_L4::bX ) );

  ufAssert( dval( cmv1, 0 ).extract( 0, 32 ).getSignedValue() == 31 );
