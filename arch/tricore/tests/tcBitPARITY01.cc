...
int main( void )
{
  ...
  ufAssert( dval( parity1, 0 ).extract( 0, 8 ).getSignedValue() == 0 );
  ufAssert( dval( parity1, 0 ).at( 8 ) == WIR_L4::bL );
  ufAssert( dval( parity1, 0 ).extract( 9, 7 ).getSignedValue() == 0 );
  ufAssert( dval( parity1, 0 ).extract( 16, 8 ).getSignedValue() == 0 );
  ufAssert( dval( parity1, 0 ).extract( 24, 8 ).getSignedValue() == 1 );
