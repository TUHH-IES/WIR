...
int main( void )
{
  ...
  // This declaration of an RV32IFD processor is needed, since this internally
  // initializes the width of the floating-point registers to 64 bits.
  RV32IFD p1;
