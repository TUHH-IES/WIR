...
Ü{\itshape archDir}Üincludedir      = ${includedir}/arch/Ü{\itshape archDir}Ü
Ü{\itshape archDir}Üinclude_HEADERS =
...
\begin{enumerate}[resume]
  ...
  Furthermore, add \\
  \verb|  arch/|\texttt{\itshape archDir}\verb|/|\texttt{\itshape newModel}\verb|.h| \\
  to the \texttt{{\itshape archDir}include\_HEADERS} directive of the very same Makefile.
\end{enumerate}
...
\end{lstlisting}
  ...
  to the \texttt{libwir\_la\_SOURCES} directive of file \texttt{WIR/arch/{\itshape archDir}/Makefile.src}.
  Furthermore, add \\
  \verb|  arch/|\texttt{\itshape archDir}\verb|/|\texttt{\itshape newModelregType}\verb|virtual.h| \\
  to the \texttt{{\itshape archDir}include\_HEADERS} directive of the very same Makefile.
\end{enumerate}
...
\end{lstlisting}
  ...
  to the \texttt{libwir\_la\_SOURCES} directive of file \texttt{WIR/arch/{\itshape archDir}/Makefile.src}.
  Furthermore, add \\
  \verb|  arch/|\texttt{\itshape archDir}\verb|/|\texttt{\itshape newModelregType}\verb|physical.h| \\
  to the \texttt{{\itshape archDir}include\_HEADERS} directive of the very same Makefile.
\end{enumerate}
...
\end{lstlisting}
  ...
  to the \texttt{libwir\_la\_SOURCES} directive of file \texttt{WIR/arch/{\itshape archDir}/Makefile.src}.
  Furthermore, add \\
  \verb|  arch/|\texttt{\itshape archDir}\verb|/|\texttt{\itshape newModel}\verb|const|\texttt{\itshape bitWidth}\verb|signed.h| \\
  to the \texttt{{\itshape archDir}include\_HEADERS} directive of the very same Makefile.
...
\begin{lstlisting}[style=code,float=t,caption={Declaration of a New Processor Model's Operation Formats},label=lst:newopformats]
class Ü{\itshape newModel}Ü : public Ü{\itshape baseClass}Ü
{
  public:
...
\begin{lstlisting}[style=code,float=!b,caption={Implementation of a New Processor Model's Operation Formats},label=lst:newopformatsimpl]
^ifdef HAVE_CONFIG_H^
^#include^ §<config_wir.h>§
^#endif^
...
\begin{lstlisting}[style=code,float=t,caption={Operation Format Registration in a New Processor Model's \texttt{init} Method},label=lst:newformatregister]
// Globally initialize a processor model.
...
\end{lstlisting}
  ...
  to the \texttt{libwir\_la\_SOURCES} directive of file \texttt{WIR/arch/{\itshape archDir}/Makefile.src}.
  Furthermore, add \\
  \verb|  arch/|\texttt{\itshape archDir}\verb|/|\texttt{\itshape newModel}\verb|io.h| \\
  to the \texttt{{\itshape archDir}include\_HEADERS} directive of the very same Makefile.

\begin{lstlisting}[style=code,float=!b,caption={Rudimentary Implementation of a New Processor Model's Stream Output},label=lst:newprocioimpl]
^ifdef HAVE_CONFIG_H^
^#include^ §<config_wir.h>§
^#endif^
