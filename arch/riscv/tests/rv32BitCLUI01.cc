...
int main( void )
{
  ...
  ufAssert( dval( clui1, 0 ).extract( 0, 32 ).getSignedValue() == 61440 );

  ufAssert( dval( clui2, 0 ).isBinaryInteger() );
  ufAssert( dval( clui2, 0 ).extract( 0, 32 ).getSignedValue() == 32768 );
