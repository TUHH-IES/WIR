...
class WIR_EntryPoint : public WIR_FlowFact
{
  public:
    ...
    */
    ...
    /*!
      @brief checkFlowFact inspects an entry point in depth and verifies that
             all flow fact-related data structures addressing this entry point
             are in a coherent state.

      @param[in] s A const reference to the WIR_System to which this entry point
                   belongs.
