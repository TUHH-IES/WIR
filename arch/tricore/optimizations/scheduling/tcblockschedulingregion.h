...
class TC_BlockSchedulingRegion : public WIR_BlockSchedulingRegion
{
  ...
  public:
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    explicit TC_BlockSchedulingRegion( WIR_BasicBlock &, bool = false,
                                       bool = false );
    ...
    */
    virtual WIR_Instruction *moveOperations( std::list<WIR_Operation *> &,
                                             const WIR_Instruction * ) override;
    ...
    */
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    virtual void postProcessingHook( void ) override;
  ...
  protected:
    ...
    */
    virtual bool checkUCert( const WIR_Operation &,
                             const WIR_RegisterParameter & ) const override;
    ...
    */
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    virtual long long getLatency( const WIR_Operation & ) override;
    ...
    */
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    virtual long long getStartCycle( const WIR_Operation & ) const override;
    ...
    */
    ...
    /*!
      @brief Silicon bug fixes for TriCore always show up in the form of two
             ...
             collected above in set mSiliconBugNOPs. The buggy operations are
