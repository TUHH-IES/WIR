...
int main( void )
{
  ...
  WIR_Operation clui1(
    RV32IMFDC::OpCode::CLUI, RV32IMFDC::OperationFormat::SRC20_1,
    new WIR_RegisterParameter( x1, WIR_Usage::def ),
