...
/*!
  @file wirpointerlistapi.h
  @brief This file provides the API for managing generic lists of pointers to
         polymorphic %WIR objects within %WIR classes.

  @author Heiko Falk <Heiko.Falk@tuhh.de>
*/


#ifndef _WIR_POINTERLIST_API_H
#define _WIR_POINTERLIST_API_H
...
/*!
  @brief Preprocessor macro WIR_POINTERLIST_DECL declares the %WIR pointer list
         API.

  @param[in] CLASSNAME Specify here the name of some actual C++ %WIR class that
                       you need to organize in a pointer list (e.g.,
                       WIR_BasicBlock). This macro assumes that the class
  ...
  @author Heiko Falk <Heiko.Falk@tuhh.de>
*/
#define WIR_POINTERLIST_DECL( CLASSNAME, CLEARNAME,PROTECTION ) \
  PROTECTION: \
    \
    /*!
      @brief pushBack##CLEARNAME adds a new CLASSNAME at the end of lists
             m##CLEARNAME##Pointers and m##CLEARNAME##References, after its
    ...
    */ \
    ...
    /*!
      ...
      @param[in] o An R-value reference to the CLASSNAME to be copy-added.
      @return A reference to the newly inserted element.
    ...
    */ \
    ...
    \
    /*!
      @brief pushFront##CLEARNAME adds a new CLASSNAME at the beginning of lists
             m##CLEARNAME##Pointers and m##CLEARNAME##References, right before
    ...
    */ \
    ...
    /*!
      ...
      @param[in] pos An iterator pointing to the position to be replaced.
      @param[in] o An R-value reference to the CLASSNAME to be copy-inserted.
      @return An iterator pointing to the newly inserted element.
    ...
    */ \
    ...
    \
    /*!
      @brief popBack##CLEARNAME removes the last CLASSNAME from lists
             m##CLEARNAME##Pointers and m##CLEARNAME##References.
    ...
    */ \
    ...
    \
    /*!
      @brief popFront##CLEARNAME removes the first CLASSNAME from lists
             m##CLEARNAME##Pointers and m##CLEARNAME##References.
    ...
    */ \
    ...
    \
    /*!
      @brief clear##CLEARNAME##s removes all elements from lists
             m##CLEARNAME##Pointers and m##CLEARNAME##References.
    ...
    */ \
    ...
    \
    /*!
      @brief get##CLEARNAME##s returns the list m##CLEARNAME##References.

      @return A const reference to the list m##CLEARNAME##References.
    ...
    */ \
    ...
    \
    /*!
      @brief contains##CLEARNAME returns whether list m##CLEARNAME##References
             contains a CLASSNAME with the specified ID.

      @param[in] id An object's ID to be found.
      @return true if m##CLEARNAME##References contains an object with the given
              ID, false otherwise.
    ...
    */ \
    ...
    /*!
      @brief contains##CLEARNAME returns whether list m##CLEARNAME##References
             contains the specified CLASSNAME##.

      @param[in] o A const reference to the CLASSNAME to be found.
      @return true if m##CLEARNAME##References contains the specified object,
              false otherwise.
  ...
  private: \
    \
    /*!
      @brief m##CLEARNAME##Pointers holds managed pointers to all stored %WIR
             CLEARNAME##s.
    */ \
    std::list<std::unique_ptr<CLASSNAME>> m##CLEARNAME##Pointers; \
    \
    /*!
