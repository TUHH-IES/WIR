...
int main( void )
{
  ...
  ufAssert( dval( dextr1, 0 ).getSignedValue() == 0x81FFFF );
  ufAssert( uval( dextr1, 1 ).extract( 11, 21 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( dextr1, 1 ).extract( 7, 4 ).isBinaryInteger() );
  ufAssert( uval( dextr1, 1 ).extract( 0, 7 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( dextr1, 2 ).extract( 30, 2 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( dextr1, 2 ).extract( 19, 11 ).isBinaryInteger() );
  ufAssert( uval( dextr1, 2 ).extract( 0, 19 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( dextr1, 3 ).isBinaryInteger() );

  ufAssert( dval( dextr2, 0 ).extract( 17, 15 ).getSignedValue() == 32645 );
  ufAssert( dval( dextr2, 0 ).extract( 0, 17 ).containsOnlyBit( WIR_L4::bL ) );

  ufAssert( dval( dextr3, 0 ).containsOnlyBit( WIR_L4::bL ) );
  ufAssert( uval( dextr3, 3 ).extract( 5, 27 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( dextr3, 3 ).extract( 0, 5 ).containsOnlyBit( WIR_L4::bL ) );
