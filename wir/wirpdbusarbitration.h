  ...
  public:
    ...
    */
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    virtual bool operator == ( const WIR_BusArbitration & ) const override;
    ...
    */
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    virtual unsigned int getNumberOfArbitratedCores( void ) const override;
  ...
  protected:
    ...
    */
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    virtual WIR_PriorityDivisionBusArbitration *clone( void ) const override;
    ...
    */
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    virtual void setMaxAccessTime( unsigned int ) override;
