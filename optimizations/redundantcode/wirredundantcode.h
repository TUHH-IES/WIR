...
/*!
  @brief Class WIR_RedundantCode is a generic, processor-independent
...
class WIR_RedundantCode : public WIR_BitOpt
{
  ...
  private:
    ...
    */
    std::map<
      std::reference_wrapper<WIR_RegisterParameter>, WIR_RegisterParameter *,
      WIR_Compare<WIR_RegisterParameter>> mParameterReplacement;
