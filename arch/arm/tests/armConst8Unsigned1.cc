...
int main( void )
{
  ...
  ARM_Const8_Unsigned p1( 0 );
  ARM_Const8_Unsigned p2( 12 );
  ARM_Const8_Unsigned p3( 27 );
  ...
  auto ref2 = dynamic_cast<ARM_Const8_Unsigned &>( ref1 );
  ufAssert( ref2.getValue() == p1.getValue() );

  // Test the copy constructors.
  ARM_Const8_Unsigned p4( p1 );
  ARM_Const8_Unsigned p5( p2 );
  ARM_Const8_Unsigned p6( p3 );
  ...
  auto ref4 = dynamic_cast<ARM_Const8_Unsigned &>( ref3 );
  ufAssert( ref4.getValue() == p5.getValue() );

  // Test the move constructors.
  ARM_Const8_Unsigned p7( std::move( p4 ) );
  ARM_Const8_Unsigned p8( std::move( p5 ) );
  ARM_Const8_Unsigned p9( std::move( p6 ) );
  ...
  auto ref6 = dynamic_cast<ARM_Const8_Unsigned &>( ref5 );
  ufAssert( ref6.getValue() == p8.getValue() );

  // Test the copy assignment operator.
  ARM_Const8_Unsigned p10( 8 );
  p10 = p1;
  ARM_Const8_Unsigned p11( 16 );
  p11 = p2;
  ARM_Const8_Unsigned p12( 24 );
  p12 = p3;
  ...
  auto ref8 = dynamic_cast<ARM_Const8_Unsigned &>( ref7 );
  ufAssert( ref8.getValue() == p10.getValue() );

  // Test the move assignment operator.
  ARM_Const8_Unsigned p13( 7 );
  p13 = std::move( p10 );
  ARM_Const8_Unsigned p14( 14 );
  p14 = std::move( p11 );
  ARM_Const8_Unsigned p15( 21 );
  p15 = std::move( p12 );
  ...
  auto ref10 = dynamic_cast<ARM_Const8_Unsigned &>( ref9 );
  ufAssert( ref10.getValue() == p14.getValue() );

  // Check min/max unsigned value for 8 bits.
  ARM_Const8_Unsigned p16( 0 );
  ARM_Const8_Unsigned p17( 255 );
