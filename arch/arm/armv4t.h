  ...
  public:
    ...
    */
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    class OpCode : public ARMv4::OpCode
    {
      ...
      protected:
        ...
        // Inherit the Constructors from ARMv4::OpCode.
        using ARMv4::OpCode::OpCode;
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    class OperationFormat : public ARMv4::OperationFormat
    {
      ...
      protected:
        ...
        // Inherit the constructors from ARMv4::OperationFormat.
        using ARMv4::OperationFormat::OperationFormat;
