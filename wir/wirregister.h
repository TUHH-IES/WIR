...
class WIR_GenericRegister : public WIR_BaseRegister
{
  ...
  public:
    ...
    */
    ...
    {
      DSTART(
        "WIR_GenericRegister<DerivedRegisterClass, "
        "Virtual>::WIR_GenericRegister(const "
        "WIR_BaseProcessor::RegisterType&)" );
    };
    ...
    */
      ...
      WIR_BaseRegister { __o }
    {
      DSTART(
        "WIR_GenericRegister<DerivedRegisterClass, "
        "Virtual>::WIR_GenericRegister(const "
        "WIR_GenericRegister<DerivedRegisterClass, Virtual>&)" );
    };
    ...
    */
    WIR_GenericRegister & operator = ( const WIR_GenericRegister &__o )
    {
      DSTART(
        "WIR_GenericRegister<DerivedRegisterClass, "
        "Virtual>& WIR_GenericRegister<DerivedRegisterClass, "
        "Virtual>::operator=(const WIR_GenericRegister<DerivedRegisterClass, "
        "Virtual>&)" );
    ...
    */
    WIR_GenericRegister & operator = ( WIR_GenericRegister &&__o )
    {
      DSTART(
        "WIR_GenericRegister<DerivedRegisterClass, "
        "Virtual>& WIR_GenericRegister<DerivedRegisterClass, "
        "Virtual>::operator=(WIR_GenericRegister<DerivedRegisterClass, "
        "Virtual>&&)" );
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    virtual bool isVirtual( void ) const override
    {
      DSTART(
        "bool WIR_GenericRegister<DerivedRegisterClass, "
        "Virtual>::isVirtual() const" );
    ...
    */
    ...
    {
      DSTART(
        "const list<reference_wrapper<DerivedRegisterClass> >& "
        "WIR_GenericRegister<DerivedRegisterClass, Virtual>::getChilds() "
        "const" );
    ...
    */
    ...
    {
      DSTART(
        "typename list<reference_wrapper<DerivedRegisterClass> "
        ">::const_iterator WIR_GenericRegister<DerivedRegisterClass, "
        "Virtual>::begin() const" );
    ...
    */
    typename std::list<std::reference_wrapper<DerivedRegisterClass>>::const_reverse_iterator rbegin( void ) const
    {
      DSTART(
        "typename list<reference_wrapper<DerivedRegisterClass> "
        ">::const_reverse_iterator WIR_GenericRegister<DerivedRegisterClass, "
        "Virtual>::rbegin() const" );
    ...
    */
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    virtual bool containsChild( WIR_id_t id ) const override
    {
      DSTART(
        "bool WIR_GenericRegister<DerivedRegisterClass, "
        "Virtual>::containsChild(WIR_id_t) const" );
    ...
    */
    bool containsChild( const DerivedRegisterClass &o ) const
    {
      DSTART(
        "bool WIR_GenericRegister<DerivedRegisterClass, "
        "Virtual>::containsChild(const DerivedRegisterClass&) const" );

      return(
        any_of(
          mChildReferences.begin(), mChildReferences.end(),
          [&]( const DerivedRegisterClass &item ) { return( item == o ); } ) );
    };
    ...
    */
    typename std::list<std::reference_wrapper<DerivedRegisterClass>>::const_iterator findChild( WIR_id_t id ) const
    {
      DSTART(
        "typename list<reference_wrapper<DerivedRegisterClass> "
        ">::const_iterator WIR_GenericRegister<DerivedRegisterClass, "
        "Virtual>::findChild(WIR_id_t) const" );

      return(
        find_if(
          mChildReferences.begin(), mChildReferences.end(),
          [&]( std::reference_wrapper<DerivedRegisterClass> ref ) {
    ...
    */
    typename std::list<std::reference_wrapper<DerivedRegisterClass>>::const_iterator findChild( const DerivedRegisterClass &o ) const
    {
      DSTART(
        "typename list<reference_wrapper<DerivedRegisterClass> "
        ">::const_iterator WIR_GenericRegister<DerivedRegisterClass, "
        "Virtual>::findChild(const DerivedRegisterClass&) const" );
    ...
    */
    ...
    {
      DSTART(
        "DerivedRegisterClass& WIR_GenericRegister<DerivedRegisterClass, "
        "Virtual>::getParent() const" );
    ...
    */
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    virtual bool hasChilds( void ) const override
    {
      DSTART(
        "bool WIR_GenericRegister<DerivedRegisterClass, Virtual>::hasChilds() "
        "const" );
    ...
    */
    ...
    {
      DSTART(
        "const vector<reference_wrapper<DerivedRegisterClass> > "
        "WIR_GenericRegister<DerivedRegisterClass, Virtual>::getLeafs() "
        "const" );
      ...
      while ( !q.empty() ) {
        ...
        if ( !( r->hasChilds() ) )
          ...
          // the ready queue.
          transform(
            r->getChilds().begin(), r->getChilds().end(), back_inserter( q ),
            [&]( DerivedRegisterClass &c ) { return( &c ); } );
      }
...
class WIR_Register<DerivedRegisterClass, true> : public WIR_GenericRegister<DerivedRegisterClass, true>
{
  ...
  public:
    ...
    */
    ...
    {
      DSTART(
        "WIR_Register<DerivedRegisterClass, true>::WIR_Register(const "
        "WIR_BaseProcessor::RegisterType&)" );
    };
    ...
    */
    ...
    {
      DSTART(
        "DerivedRegisterClass& WIR_Register<DerivedRegisterClass, "
        "true>::operator=(const DerivedRegisterClass&)" );
    ...
    */
    DerivedRegisterClass & operator = ( DerivedRegisterClass &&__o )
    {
      DSTART(
        "DerivedRegisterClass& WIR_Register<DerivedRegisterClass, "
        "true>::operator=(DerivedRegisterClass&&)" );
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    virtual bool isInserted( void ) const override
    {
      DSTART(
    ...
    */
    ...
    {
      DSTART(
        "WIR_Function& WIR_Register<DerivedRegisterClass, true>::getFunction() "
        "const" );
    ...
    */
    ...
    {
      DSTART(
        "WIR_PhysicalRegister& WIR_Register<DerivedRegisterClass, "
        "true>::getPrecolor() const" );
    ...
    /*!
      @brief releaseChilds releases a hierarchical register's childs from the
             parent's memory management and this way resolves the hierarchy
             between the parent register and its childs.

      @return A list with unmanaged (!) pointers to the individiual child
              registers.

      @details If the parent register is inserted into a %WIR function, its
               previous childs are added to the same function, too. This way,
               the associated %WIR function automatically becomes responsible
               for the deletion of the previous child registers.

               If, however, the parent register is not inserted, the child
               registers are not inserted, too. Thus, the caller of
               releaseChilds becomes responsible for the management of the
               pointers returned by this method.

      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    std::list<DerivedRegisterClass *> releaseChilds( void )
    {
      DSTART(
        "list<DerivedRegisterClass*> WIR_Register<DerivedRegisterClass, "
        "true>::releaseChilds()" );

      std::list<DerivedRegisterClass *> res;

      for ( auto &up : mChildPointers ) {
        auto *p = up.release();
        p->mParent = nullptr;
        res.push_back( p );

        if ( isInserted() )
          mFunctionPointer->pushBackVirtualRegister( p );
      }
  ...
  protected:
    ...
    */
    DerivedRegisterClass & pushBackChild( const DerivedRegisterClass &o )
    {
      DSTART(
        "DerivedRegisterClass& WIR_Register<DerivedRegisterClass, "
        "true>::pushBackChild(const DerivedRegisterClass&)" );
    ...
    */
    DerivedRegisterClass & pushBackChild( DerivedRegisterClass &&o )
    {
      DSTART(
        "DerivedRegisterClass& WIR_Register<DerivedRegisterClass, "
        "true>::pushBackChild(DerivedRegisterClass&&)" );
...
std::cout << BOOST_CURRENT_FUNCTION << std::endl;
    ...
    */
    ...
    {
      DSTART(
        "void WIR_Register<DerivedRegisterClass, true>::onInsert("
        "WIR_Function*)" );
  ...
  private:
    ...
    */
    ...
    /*!
      ...
      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    virtual WIR_BaseRegister *clone( void ) const override
    {
      DSTART(
        "WIR_BaseRegister* WIR_Register<DerivedRegisterClass, true>::clone() "
        "const" );
...
class WIR_Register<DerivedRegisterClass, false> : public WIR_GenericRegister<DerivedRegisterClass, false>
{
  ...
  public:
    ...
    */
    ...
    {
      DSTART(
        "WIR_BaseProcessor& WIR_Register<DerivedRegisterClass, "
        "false>::getProcessor() const" );
    ...
    */
    ...
    {
      DSTART(
        "bool WIR_Register<DerivedRegisterClass, false>::isStackPointer() "
        "const" );
  ...
  protected:
    ...
    */
    ...
    {
      DSTART(
        "WIR_Register<DerivedRegisterClass, false>::WIR_Register(const "
        "WIR_BaseProcessor::RegisterType&, const string&, bool)" );
...
std::cout << BOOST_CURRENT_FUNCTION << std::endl;
    ...
    */
    DerivedRegisterClass & pushBackChild( DerivedRegisterClass &o )
    {
      DSTART(
        "DerivedRegisterClass& WIR_Register<DerivedRegisterClass, "
        "false>::pushBackChild(DerivedRegisterClass&)" );
...
std::cout << BOOST_CURRENT_FUNCTION << std::endl;
    ...
    */
    ...
    {
      DSTART(
        "void WIR_Register<DerivedRegisterClass, "
        "false>::onInsert(WIR_BaseProcessor*)" );
  ...
  private:
    ...
    */
    ...
    {
      DSTART(
        "WIR_BaseRegister* WIR_Register<DerivedRegisterClass, false>::clone() "
        "const" );
