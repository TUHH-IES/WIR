...
int main( void )
{
  ...
  ufAssert( uval( bgeu1, 0 ).extract( 0, 10 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( bgeu1, 0 ).extract( 10, 1 ).containsOnlyBit( WIR_L4::b1 ) );
  ufAssert( uval( bgeu1, 0 ).extract( 11, 21 ).containsOnlyBit( WIR_L4::b0 ) );

  ufAssert( uval( bgeu1, 1 ).extract( 0, 10 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( bgeu1, 1 ).extract( 10, 22 ).containsOnlyBit( WIR_L4::b0 ) );
