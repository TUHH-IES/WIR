...
int main( void )
{
  ...
  RV_ERegV r1;
  ufAssert( r1.getType() == RV32I::RegisterType::eReg );
  ufAssert( r1.getBitWidth() == 64 );
  ufAssert( r1.isVirtual() );
  ufAssert( !r1.isPhysical() );
  ufAssert( !r1.isInserted() );
  str.str( "" );
  str << RV32I::RegisterType::eReg.getPrefixes()[ 1 ] << r1.getID()
      << RV32I::RegisterType::eReg.getSuffixes()[ 1 ];
  ...
  ufAssert( c1.getType() == RV32I::RegisterType::reg );
  ...
  ufAssert( c2.getType() == RV32I::RegisterType::reg );
  ...
  WIR_Function f( "foo" );
  auto &tr1 = f.pushBackVirtualRegister( RV_ERegV() );
  RV_ERegV &r2 = static_cast<RV_ERegV &>( tr1 );

  ufAssert( r2.getType() == RV32I::RegisterType::eReg );
  ufAssert( r2.getBitWidth() == 64 );
  ufAssert( r2.isVirtual() );
  ufAssert( !r2.isPhysical() );
  ufAssert( r2.isInserted() );
  str.str( "" );
  str << RV32I::RegisterType::eReg.getPrefixes()[ 1 ] << r2.getID()
      << RV32I::RegisterType::eReg.getSuffixes()[ 1 ];
  ...
  ufAssert( c3.getType() == RV32I::RegisterType::reg );
  ...
  ufAssert( c4.getType() == RV32I::RegisterType::reg );
  ...
  ufAssert( r3.getType() == RV32I::RegisterType::eReg );
  ufAssert( r3.getBitWidth() == 64 );
  ufAssert( r3.isVirtual() );
  ufAssert( !r3.isPhysical() );
  ufAssert( !r3.isInserted() );
  str.str( "" );
  str << RV32I::RegisterType::eReg.getPrefixes()[ 1 ] << r3.getID()
      << RV32I::RegisterType::eReg.getSuffixes()[ 1 ];
  ...
  ufAssert( c5.getType() == RV32I::RegisterType::reg );
  ...
  ufAssert( c6.getType() == RV32I::RegisterType::reg );
  ...
  ufAssert( r4.getType() == RV32I::RegisterType::eReg );
  ufAssert( r4.getBitWidth() == 64 );
  ufAssert( r4.isVirtual() );
  ufAssert( !r4.isPhysical() );
  ufAssert( !r4.isInserted() );
  str.str( "" );
  str << RV32I::RegisterType::eReg.getPrefixes()[ 1 ] << r4.getID()
      << RV32I::RegisterType::eReg.getSuffixes()[ 1 ];
  ...
  ufAssert( c7.getType() == RV32I::RegisterType::reg );
  ...
  ufAssert( c8.getType() == RV32I::RegisterType::reg );
  ...
  ufAssert( r5.getType() == RV32I::RegisterType::eReg );
  ufAssert( r5.getBitWidth() == 64 );
  ufAssert( r5.isVirtual() );
  ufAssert( !r5.isPhysical() );
  ufAssert( !r5.isInserted() );
  str.str( "" );
  str << RV32I::RegisterType::eReg.getPrefixes()[ 1 ] << r5.getID()
      << RV32I::RegisterType::eReg.getSuffixes()[ 1 ];
  ...
  ufAssert( c9.getType() == RV32I::RegisterType::reg );
  ...
  ufAssert( c10.getType() == RV32I::RegisterType::reg );
  ...
  ufAssert( r6.getType() == RV32I::RegisterType::eReg );
  ufAssert( r6.getBitWidth() == 64 );
  ufAssert( r6.isVirtual() );
  ufAssert( !r6.isPhysical() );
  ufAssert( !r6.isInserted() );
  str.str( "" );
  str << RV32I::RegisterType::eReg.getPrefixes()[ 1 ] << r6.getID()
      << RV32I::RegisterType::eReg.getSuffixes()[ 1 ];
  ...
  ufAssert( c11.getType() == RV32I::RegisterType::reg );
  ...
  ufAssert( c12.getType() == RV32I::RegisterType::reg );
  ...
  RV_ERegV r7 = std::move( r1 );

  ufAssert( r7.getType() == RV32I::RegisterType::eReg );
  ufAssert( r7.getBitWidth() == 64 );
  ufAssert( r7.isVirtual() );
  ufAssert( !r7.isPhysical() );
  ufAssert( !r7.isInserted() );
  str.str( "" );
  str << RV32I::RegisterType::eReg.getPrefixes()[ 1 ] << r7.getID()
      << RV32I::RegisterType::eReg.getSuffixes()[ 1 ];
  ...
  ufAssert( c13.getType() == RV32I::RegisterType::reg );
  ...
  ufAssert( c14.getType() == RV32I::RegisterType::reg );
  ...
  ufAssert( r8.getType() == RV32I::RegisterType::eReg );
  ufAssert( r8.getBitWidth() == 64 );
  ufAssert( r8.isVirtual() );
  ufAssert( !r8.isPhysical() );
  ufAssert( !r8.isInserted() );
  str.str( "" );
  str << RV32I::RegisterType::eReg.getPrefixes()[ 1 ] << r8.getID()
      << RV32I::RegisterType::eReg.getSuffixes()[ 1 ];
  ...
  ufAssert( c15.getType() == RV32I::RegisterType::reg );
  ...
  ufAssert( c16.getType() == RV32I::RegisterType::reg );
