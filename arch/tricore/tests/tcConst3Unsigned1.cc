...
int main( void )
{
  ...
  TC_Const3_Unsigned p1( 0 );
  TC_Const3_Unsigned p2( 1 );
  TC_Const3_Unsigned p3( 2 );
  ...
  auto ref2 = dynamic_cast<TC_Const3_Unsigned &>( ref1 );
  ufAssert( ref2.getValue() == p1.getValue() );

  // Test the copy constructors.
  TC_Const3_Unsigned p4( p1 );
  TC_Const3_Unsigned p5( p2 );
  TC_Const3_Unsigned p6( p3 );
  ...
  auto ref4 = dynamic_cast<TC_Const3_Unsigned &>( ref3 );
  ufAssert( ref4.getValue() == p5.getValue() );

  // Test the move constructors.
  TC_Const3_Unsigned p7( std::move( p4 ) );
  TC_Const3_Unsigned p8( std::move( p5 ) );
  TC_Const3_Unsigned p9( std::move( p6 ) );
  ...
  auto ref6 = dynamic_cast<TC_Const3_Unsigned &>( ref5 );
  ufAssert( ref6.getValue() == p8.getValue() );

  // Test the copy assignment operator.
  TC_Const3_Unsigned p10( 0 );
  p10 = p1;
  TC_Const3_Unsigned p11( 1 );
  p11 = p2;
  TC_Const3_Unsigned p12( 2 );
  p12 = p3;
  ...
  auto ref8 = dynamic_cast<TC_Const3_Unsigned &>( ref7 );
  ufAssert( ref8.getValue() == p10.getValue() );

  // Test the move assignment operator.
  TC_Const3_Unsigned p13( 1 );
  p13 = std::move( p10 );
  TC_Const3_Unsigned p14( 2 );
  p14 = std::move( p11 );
  TC_Const3_Unsigned p15( 3 );
  p15 = std::move( p12 );
  ...
  auto ref10 = dynamic_cast<TC_Const3_Unsigned &>( ref9 );
  ufAssert( ref10.getValue() == p14.getValue() );

  // Check min/max unsigned value for 3 bits.
  TC_Const3_Unsigned p16( 0 );
  TC_Const3_Unsigned p17( 7 );
