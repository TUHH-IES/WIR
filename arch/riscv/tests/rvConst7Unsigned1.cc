...
int main( void )
{
  ...
  RV_Const7_Unsigned p1( 0 );
  RV_Const7_Unsigned p2( 12 );
  RV_Const7_Unsigned p3( 16 );
  ...
  ufAssert( p3.getValue() == 16 );

  p1.setValue( 4 );
  p2.setValue( 16 );
  p3.setValue( 20 );

  ufAssert( p1.getValue() == 4 );
  ufAssert( p2.getValue() == 16 );
  ufAssert( p3.getValue() == 20 );
  ...
  auto ref2 = dynamic_cast<RV_Const7_Unsigned &>( ref1 );
  ufAssert( ref2.getValue() == p1.getValue() );

  // Test the copy constructors.
  RV_Const7_Unsigned p4( p1 );
  RV_Const7_Unsigned p5( p2 );
  RV_Const7_Unsigned p6( p3 );

  ufAssert( p4.getType() == WIR_ParameterType::imm );
  ufAssert( p4.getType() == p5.getType() );
  ufAssert( p5.getType() == p6.getType() );

  ufAssert( p4.getValue() == 4 );
  ufAssert( p5.getValue() == 16 );
  ufAssert( p6.getValue() == 20 );
  ...
  auto ref4 = dynamic_cast<RV_Const7_Unsigned &>( ref3 );
  ufAssert( ref4.getValue() == p5.getValue() );

  // Test the move constructors.
  RV_Const7_Unsigned p7( std::move( p4 ) );
  RV_Const7_Unsigned p8( std::move( p5 ) );
  RV_Const7_Unsigned p9( std::move( p6 ) );

  ufAssert( p7.getType() == WIR_ParameterType::imm );
  ufAssert( p7.getType() == p8.getType() );
  ufAssert( p8.getType() == p9.getType() );

  ufAssert( p7.getValue() == 4 );
  ufAssert( p8.getValue() == 16 );
  ufAssert( p9.getValue() == 20 );
  ...
  auto ref6 = dynamic_cast<RV_Const7_Unsigned &>( ref5 );
  ufAssert( ref6.getValue() == p8.getValue() );

  // Test the copy assignment operator.
  RV_Const7_Unsigned p10( 0 );
  p10 = p1;
  RV_Const7_Unsigned p11( 0 );
  p11 = p2;
  RV_Const7_Unsigned p12( 0 );
  p12 = p3;
  ...
  ufAssert( p10.getValue() == 4 );
  ufAssert( p11.getValue() == 16 );
  ufAssert( p12.getValue() == 20 );
  ...
  auto ref8 = dynamic_cast<RV_Const7_Unsigned &>( ref7 );
  ufAssert( ref8.getValue() == p10.getValue() );

  // Test the move assignment operator.
  RV_Const7_Unsigned p13( 0 );
  p13 = std::move( p10 );
  RV_Const7_Unsigned p14( 0 );
  p14 = std::move( p11 );
  RV_Const7_Unsigned p15( 0 );
  p15 = std::move( p12 );
  ...
  ufAssert( p13.getValue() == 4 );
  ufAssert( p14.getValue() == 16 );
  ufAssert( p15.getValue() == 20 );
  ...
  auto ref10 = dynamic_cast<RV_Const7_Unsigned &>( ref9 );
  ufAssert( ref10.getValue() == p14.getValue() );

  // Check min/max unsigned value for 7 bits (Scaling context).
  RV_Const7_Unsigned p16( 0 );
  RV_Const7_Unsigned p17( 124 );
