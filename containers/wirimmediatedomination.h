...
class WIR_ImmediateDomination : public WIR_Container<WIR_ImmediateDomination>
{
  ...
  public:
    ...
    */
    ...
    /*!
      @brief setImmediateDominator sets a new immediate dominator.

      @param[in] b A reference to the immediate dominator block to be set.

      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    void setImmediateDominator( WIR_BasicBlock & );
