...
int main( void )
{
  ...
  ARM_Const5_SatPos p1( 5 );
  ARM_Const5_SatPos p2( 12 );
  ARM_Const5_SatPos p3( 9 );
  ...
  ufAssert( p1.getValue() == 5 );
  ufAssert( p2.getValue() == 12 );
  ufAssert( p3.getValue() == 9 );
  ...
  auto ref4 = dynamic_cast<ARM_Const5_SatPos &>( ref3 );
  ufAssert( ref4.getValue() == p5.getValue() );

  // Test the move constructors.
  ARM_Const5_SatPos p7( std::move( p4 ) );
  ARM_Const5_SatPos p8( std::move( p5 ) );
  ARM_Const5_SatPos p9( std::move( p6 ) );

  ufAssert( p7.getType() == WIR_ParameterType::imm );
  ufAssert( p7.getType() == p8.getType() );
  ufAssert( p8.getType() == p9.getType() );

  ufAssert( p7.getValue() == 16 );
  ...
  auto ref6 = dynamic_cast<ARM_Const5_SatPos &>( ref5 );
  ufAssert( ref6.getValue() == p8.getValue() );

  // Test the copy assignment operator.
  ARM_Const5_SatPos p10( 8 );
  p10 = p1;
  ARM_Const5_SatPos p11( 16 );
  p11 = p2;
  ARM_Const5_SatPos p12( 2 );
  p12 = p3;
  ...
  auto ref8 = dynamic_cast<ARM_Const5_SatPos &>( ref7 );
  ufAssert( ref8.getValue() == p10.getValue() );

  // Test the move assignment operator.
  ARM_Const5_SatPos p13( 7 );
  p13 = std::move( p10 );
  ARM_Const5_SatPos p14( 14 );
  p14 = std::move( p11 );
  ARM_Const5_SatPos p15( 9 );
  p15 = std::move( p12 );
  ...
  auto ref10 = dynamic_cast<ARM_Const5_SatPos &>( ref9 );
  ufAssert( ref10.getValue() == p14.getValue() );

  // Check min/max unsigned value for saturation positions.
  ARM_Const5_SatPos p16( 1 );
  ARM_Const5_SatPos p17( 16 );
