...
{
  DSTART(
    "virtual bool TC_ConstProp::doConstProp(const WIR_Operation&, const "
  ...
  if ( ( ( ( ( o.getOpCode() == TC13::OpCode::ABSDIF ) ||
    ...
    auto instrs = prop_DDD_DDC9( o, lastVal( o, inValue ) );
    if ( !instrs.empty() ) {
  ...
  if ( ( ( ( ( o.getOpCode() == TC13::OpCode::ADD ) ||
    ...
    auto instrs = prop_DDD_DDC9_2( o, nthVal( o, inValue, 1 ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( ( o.getOpCode() == TC13::OpCode::ADDC ) ||
       ...
       nthVal( o, inValue, 2 ).isInteger() ) {
    auto instrs = prop_DDD_DDC9_6( o, nthVal( o, inValue, 2 ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( ( o.getOpCode() == TC13::OpCode::ADDC ) ||
         ...
         ( ( o.getOperationFormat() == TC13::OperationFormat::DDDPSW_2 ) ||
           ( o.getOperationFormat() == TC13::OperationFormat::DDDPSW_1 ) ) ) &&
       nthVal( o, inValue, 1 ).isInteger() ) {
    auto instrs = prop_DDD_DDC9_7( o, nthVal( o, inValue, 1 ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( o.getOpCode() == TC13::OpCode::ADD ) &&
       ( o.getOperationFormat() == TC13::OperationFormat::DDD_1 ) &&
       lastVal( o, inValue ).isInteger() ) {
    auto instrs = prop_DDD_DDC16( o, lastVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( o.getOpCode() == TC13::OpCode::ADD ) &&
       ( o.getOperationFormat() == TC13::OperationFormat::DDD_1 ) &&
       nthVal( o, inValue, 1 ).isInteger() ) {
    auto instrs = prop_DDD_DDC16_1( o, nthVal( o, inValue, 1 ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( ( o.getOpCode() == TC13::OpCode::ADD ) &&
       ...
       lastVal( o, inValue ).isInteger() ) {
    auto instrs = prop_xxx_xxC16( o, lastVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( ( o.getOpCode() == TC13::OpCode::ADD ) &&
         ...
         ( ( o.getOpCode() == TC13::OpCode::ADD_A ) &&
           ( o.getOperationFormat() == TC13::OperationFormat::AAA ) ) ) &&
       nthVal( o, inValue, 1 ).isInteger() ) {
    auto instrs = prop_xxx_xxC16_1( o, nthVal( o, inValue, 1 ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( ( ( o.getOpCode() == TC13::OpCode::GE ) ||
         ...
         ( ( ( o.getOpCode() == TC13::OpCode::AND_GE ) ||
           ...
           ( o.getOperationFormat() == TC13::OperationFormat::DDD_2 ) ) ) &&
       nthVal( o, inValue, 1 ).isInteger() ) {
    auto instrs = prop_DDD_DDC9_3( o, nthVal( o, inValue, 1 ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( o.getOpCode() == TC13::OpCode::SUB ) ||
       ...
       ( o.getOperationFormat() == TC13::OperationFormat::DDD_1 ) &&
       lastVal( o, inValue ).isInteger() ) {
    auto instrs = prop_DDD_DDC9_4( o, lastVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( o.getOpCode() == TC13::OpCode::SUB ) ||
       ...
       ( o.getOperationFormat() == TC13::OperationFormat::DDD_1 ) &&
       nthVal( o, inValue, 1 ).isInteger() ) {
    auto instrs = prop_DDD_DDC9_5( o, nthVal( o, inValue, 1 ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( ( ( o.getOpCode() == TC13::OpCode::AND ) ||
       ...
       lastVal( o, inValue ).isInteger() ) {
    auto instrs = prop_xDD_DDC9_u( o, lastVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( ( ( o.getOpCode() == TC13::OpCode::AND ) ||
         ...
         ( ( o.getOpCode() == TC13::OpCode::MUL_U ) &&
           ( o.getOperationFormat() == TC13::OperationFormat::EDD ) ) ) &&
       nthVal( o, inValue, 1 ).isInteger() ) {
    auto instrs = prop_xDD_DDC9_2u( o, nthVal( o, inValue, 1 ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( ( ( o.getOpCode() == TC13::OpCode::GE_U ) ||
         ...
         ( ( ( o.getOpCode() == TC13::OpCode::AND_GE_U ) ||
           ...
           ( o.getOperationFormat() == TC13::OperationFormat::DDD_2 ) ) ) &&
       nthVal( o, inValue, 1 ).isInteger() ) {
    auto instrs = prop_DDD_DDC9_3u( o, nthVal( o, inValue, 1 ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( o.getOpCode() == TC13::OpCode::CADD ) ||
       ...
       lastVal( o, inValue ).isInteger() ) {
    auto instrs = prop_xxDD_xxDC9( o, lastVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( o.getOpCode() == TC13::OpCode::MADD ) ||
       ...
       ( ( o.getOperationFormat() == TC13::OperationFormat::DDDD ) ||
         ( o.getOperationFormat() == TC13::OperationFormat::EEDD ) ) &&
       nthVal( o, inValue, 2 ).isInteger() ) {
    auto instrs = prop_xxDD_xxDC9_2( o, nthVal( o, inValue, 2 ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( o.getOpCode() == TC13::OpCode::CSUB ) ||
       ...
       lastVal( o, inValue ).isInteger() ) {
    auto instrs = prop_CSUB( o, lastVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
exit( 4 );
  ...
  if ( ( ( o.getOpCode() == TC13::OpCode::MADD_U ) ||
       ...
       ( ( o.getOperationFormat() == TC13::OperationFormat::DDDD ) ||
         ( o.getOperationFormat() == TC13::OperationFormat::EEDD ) ) &&
       lastVal( o, inValue ).isInteger() ) {
    auto instrs = prop_xxDD_xxDC9_u( o, lastVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( o.getOpCode() == TC13::OpCode::MADD_U ) ||
       ...
       ( ( o.getOperationFormat() == TC13::OperationFormat::DDDD ) ||
         ( o.getOperationFormat() == TC13::OperationFormat::EEDD ) ) &&
       nthVal( o, inValue, 2 ).isInteger() ) {
    auto instrs = prop_xxDD_xxDC9_2u( o, nthVal( o, inValue, 2 ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
exit( 5 );
  ...
  if ( ( ( ( o.getOpCode() == TC13::OpCode::ADD ) &&
       ...
       lastVal( o, inValue ).isInteger() ) {
    auto instrs = prop_Sxx_SxC4( o, lastVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( o.getOpCode() == TC13::OpCode::AND ) ||
         ( o.getOpCode() == TC13::OpCode::OR ) ) &&
       ( o.getOperationFormat() == TC13::OperationFormat::SDD_2 ) &&
       TC13::isD15( firstReg( o ) ) && lastVal( o, inValue ).isInteger() ) {
    auto instrs = prop_SDD_SIC8_2( o, lastVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
exit( 6 );
  ...
  if ( ( ( ( ( o.getOpCode() == TC13::OpCode::CMOV ) ||
       ...
       lastVal( o, inValue ).isInteger() ) {
    auto instrs = prop_SIxD_SIxC4( o, lastVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
exit( 1 );
  ...
  if ( ( ( o.getOpCode() == TC13::OpCode::ADD ) ||
       ...
       ( o.getOperationFormat() == TC13::OperationFormat::SIDD ) &&
       nthVal( o, inValue, 1 ).isInteger() ) {
    auto instrs = prop_SIxD_SIxC4_2( o, nthVal( o, inValue, 1 ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
exit( 2 );
  ...
  if ( ( o.getOpCode() == TC13::OpCode::SUB ) &&
       ( ( o.getOperationFormat() == TC13::OperationFormat::SIDD ) ||
         ( o.getOperationFormat() == TC13::OperationFormat::SDID_1 ) ) &&
       lastVal( o, inValue ).isInteger() ) {
    auto instrs = prop_SIxD_SIDC4( o, lastVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
exit( 3 );
  ...
  if ( ( ( o.getOpCode() == TC13::OpCode::ADD ) ||
       ...
       ( o.getOperationFormat() == TC13::OperationFormat::SDD_2 ) &&
       lastVal( o, inValue ).isInteger() ) {
    auto instrs = prop_SDD_DDC9( o, lastVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( o.getOpCode() == TC13::OpCode::ADD ) ||
    ...
    auto instrs = prop_SDD_DDC9_2( o, firstVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( o.getOpCode() == TC13::OpCode::SUB ) ||
       ...
       ( o.getOperationFormat() == TC13::OperationFormat::SDD_2 ) &&
       lastVal( o, inValue ).isInteger() ) {
    auto instrs = prop_SDD_DDC9_3( o, lastVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( o.getOpCode() == TC13::OpCode::SUB ) ||
       ...
       ( o.getOperationFormat() == TC13::OperationFormat::SDD_2 ) &&
       firstVal( o, inValue ).isInteger() ) {
    auto instrs = prop_SDD_DDC9_4( o, firstVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( o.getOpCode() == TC13::OpCode::AND ) ||
       ...
       ( o.getOperationFormat() == TC13::OperationFormat::SDD_2 ) &&
       lastVal( o, inValue ).isInteger() ) {
    auto instrs = prop_SDD_DDC9_u( o, lastVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( o.getOpCode() == TC13::OpCode::AND ) ||
       ...
       ( o.getOperationFormat() == TC13::OperationFormat::SDD_2 ) &&
       firstVal( o, inValue ).isInteger() ) {
    auto instrs = prop_SDD_DDC9_2u( o, firstVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( o.getOpCode() == TC13::OpCode::JEQ ) ||
       ...
       nthVal( o, inValue, 1 ).isInteger() ) {
    auto instrs = prop_DDL_DC4L( o, nthVal( o, inValue, 1 ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( o.getOpCode() == TC13::OpCode::JEQ ) ||
       ...
       ( o.getOperationFormat() == TC13::OperationFormat::DDL_1 ) &&
       firstVal( o, inValue ).isInteger() ) {
    auto instrs = prop_DDL_DC4L_2( o, firstVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( o.getOpCode() == TC13::OpCode::JGE ) ||
       ...
       ( o.getOperationFormat() == TC13::OperationFormat::DDL_1 ) &&
       firstVal( o, inValue ).isInteger() ) {
    auto instrs = prop_DDL_DC4L_3( o, firstVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( o.getOpCode() == TC13::OpCode::JGE_U ) ||
       ...
       ( o.getOperationFormat() == TC13::OperationFormat::DDL_1 ) &&
       nthVal( o, inValue, 1 ).isInteger() ) {
    auto instrs = prop_DDL_DC4L_u( o, nthVal( o, inValue, 1 ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( o.getOpCode() == TC13::OpCode::JGE_U ) ||
       ...
       ( o.getOperationFormat() == TC13::OperationFormat::DDL_1 ) &&
       firstVal( o, inValue ).isInteger() ) {
    auto instrs = prop_DDL_DC4L_2u( o, firstVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( o.getOpCode() == TC13::OpCode::JEQ ) ||
       ...
       nthVal( o, inValue, 1 ).isInteger() ) {
    auto instrs = prop_SIDL_SIC4L( o, nthVal( o, inValue, 1 ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
exit( 10 );
  ...
  if ( ( o.getOpCode() == TC13::OpCode::MOV_A ) &&
       ...
       lastVal( o, inValue ).isInteger() ) {
    auto instrs = prop_AD_SAC4( o, lastVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( o.getOpCode() == TC13::OpCode::MOV_RR ) &&
       ...
       lastVal( o, inValue ).isInteger() ) {
    auto instrs = prop_DD_SDC4( o, lastVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( o.getOpCode() == TC13::OpCode::MOV_RR ) &&
       ( ( o.getOperationFormat() == TC13::OperationFormat::DD ) ||
         ( o.getOperationFormat() == TC13::OperationFormat::SDD_1 ) ) &&
       TC13::isD15( firstReg( o ) ) && lastVal( o, inValue ).isInteger() ) {
    auto instrs = prop_DD_SIC8( o, lastVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( o.getOpCode() == TC13::OpCode::MOV_RR ) &&
       ( ( o.getOperationFormat() == TC13::OperationFormat::DD ) ||
         ( o.getOperationFormat() == TC13::OperationFormat::SDD_1 ) ) &&
       lastVal( o, inValue ).isInteger() ) {
    auto instrs = prop_DD_DC16( o, lastVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( o.getOpCode() == TC13::OpCode::MOV_RR ) &&
       ( ( o.getOperationFormat() == TC13::OperationFormat::DD ) ||
         ( o.getOperationFormat() == TC13::OperationFormat::SDD_1 ) ) &&
       lastVal( o, inValue ).isInteger() ) {
    auto instrs = prop_DD_DC16_1( o, lastVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( ( o.getOpCode() == TC13::OpCode::MOV_RR ) &&
       ...
       lastVal( o, inValue ).isInteger() ) {
    auto instrs = prop_xx_xC16( o, lastVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( o.getOpCode() == TC13::OpCode::EXTR ) ||
       ...
       nthVal( o, inValue, 2 ).extract( 0, 5 ).isInteger() ) {
    auto instrs = prop_DDDC5_DDC5C5( o, nthVal( o, inValue, 2 ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( o.getOpCode() == TC13::OpCode::EXTR ) ||
       ...
       lastVal( o, inValue ).extract( 32, 5 ).isInteger() &&
       lastVal( o, inValue ).extract( 0, 5 ).isInteger() ) {
    auto instrs = prop_DDE_DDC5C5( o, lastVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
exit( 11 );
  ...
  if ( ( ( o.getOpCode() == TC13::OpCode::EXTR ) ||
       ...
       ( o.getOperationFormat() == TC13::OperationFormat::DDE ) &&
       lastVal( o, inValue ).extract( 32, 5 ).isInteger() ) {
    auto instrs = prop_DDE_DDC5C5_2( o, lastVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
exit( 12 );
  ...
  if ( ( o.getOpCode() == TC13::OpCode::DEXTR ) &&
       ( o.getOperationFormat() == TC13::OperationFormat::DDDD ) &&
       lastVal( o, inValue ).extract( 0, 5 ).isInteger() ) {
    auto instrs = prop_DDDD_DDDC5( o, lastVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( o.getOpCode() == TC13::OpCode::INSERT ) &&
       ...
       nthVal( o, inValue, 3 ).extract( 0, 5 ).isInteger() ) {
    auto instrs = prop_DDxDC5_DDxC5C5( o, nthVal( o, inValue, 3 ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( o.getOpCode() == TC13::OpCode::INSERT ) &&
       ...
       lastVal( o, inValue ).extract( 32, 5 ).isInteger() &&
       lastVal( o, inValue ).extract( 0, 5 ).isInteger() ) {
    auto instrs = prop_DDxE_DDxC5C5( o, lastVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( o.getOpCode() == TC13::OpCode::INSERT ) &&
       ( ( o.getOperationFormat() == TC13::OperationFormat::DDC4E ) ||
         ( o.getOperationFormat() == TC13::OperationFormat::DDDE ) ) &&
       lastVal( o, inValue ).extract( 32, 5 ).isInteger() ) {
    auto instrs = prop_DDxE_DDxC5C5_2( o, lastVal( o, inValue ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( o.getOpCode() == TC13::OpCode::IMASK ) &&
       ...
       nthVal( o, inValue, 2 ).extract( 0, 5 ).isInteger() ) {
    auto instrs =
      prop_EDDC5_EC4C5C5( o, nthVal( o, inValue, 1 ), nthVal( o, inValue, 2 ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
exit( 8 );
  ...
  if ( ( o.getOpCode() == TC13::OpCode::IMASK ) &&
       ( ( o.getOperationFormat() == TC13::OperationFormat::EC4DC5 ) ||
         ( o.getOperationFormat() == TC13::OperationFormat::EDDC5 ) ) &&
       nthVal( o, inValue, 2 ).extract( 0, 5 ).isInteger() ) {
    auto instrs = prop_ExDC5_ExC5C5( o, nthVal( o, inValue, 2 ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( o.getOpCode() == TC13::OpCode::IMASK ) &&
       ( ( o.getOperationFormat() == TC13::OperationFormat::EDC5C5 ) ||
         ( o.getOperationFormat() == TC13::OperationFormat::EDDC5 ) ) &&
       nthVal( o, inValue, 1 ).isInteger() ) {
    auto instrs = prop_EDxC5_EC4xC5( o, nthVal( o, inValue, 1 ) );
    if ( !instrs.empty() ) {
      mNewInstructions.emplace(
        const_cast<WIR_Operation &>( o ), std::move( instrs ) );
      return( true );
  ...
  if ( ( ( o.getOpCode() == TC13::OpCode::LD_A ) ||
    ...
    auto &aregValue = nthVal( o, inValue, 1 );
  ...
  if ( ( o.getOpCode() == TC13::OpCode::ST_W ) &&
    ...
    auto &aregValue = firstVal( o, inValue );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_DDD_DDC9(const WIR_Operation&, "
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_DDD_DDC9_2(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_DDD_DDC9_3(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_DDD_DDC9_4(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_DDD_DDC9_5(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_DDD_DDC9_6(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_DDD_DDC9_7(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_DDD_DDC16(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_DDD_DDC16_1(const "
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_xxx_xxC16(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_xxx_xxC16_1(const "
    "WIR_Operation&, const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_xDD_DDC9_u(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_xDD_DDC9_2u(const "
    "WIR_Operation&, const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_DDD_DDC9_3u(const "
    "WIR_Operation&, const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_xxDD_xxDC9(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_xxDD_xxDC9_2(const "
    "WIR_Operation&, const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_xxDD_xxDC9_u(const "
    "WIR_Operation&, const WIR_UpDownValue&)" );
  ...
  if ( c0fits ) {
    ...
    auto *p3 =
      new WIR_RegisterParameter(
        dynamic_cast<const WIR_RegisterParameter &>( it->get() ) );
    const auto &p4o = it->get();
    const auto *p4 = new TC_Const9_Unsigned( c0 );
    ...
    // Add bit-value container for new immediate parameter p4.
    patchImmediateParameter( const_cast<TC_Const9_Unsigned &>( *p4 ) );

    res.push_back(
      { { o.getOpCode(),
          o.getOperationFormat() == TC13::OperationFormat::DDDD ?
            TC13::OperationFormat::DDDC9_2 : TC13::OperationFormat::EEDC9_2,
          p1, p2, p3, const_cast<TC_Const9_Unsigned *>( p4 ) } } );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_Sxx_SxC4(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_SDD_DDC9(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_SDD_DDC9_2(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_SDD_DDC9_3(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_SDD_DDC9_4(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_SIxD_SIxC4(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_SDD_DDC9_u(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_DDL_DC4L(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_DDL_DC4L_2(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_DDL_DC4L_3(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_DDL_DC4L_u(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_DDL_DC4L_2u(const "
    "WIR_Operation&, const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_AD_SAC4(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_DD_SDC4(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_DD_SIC8(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_DD_DC16(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_DD_DC16_1(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_xx_xC16(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_DDDC5_DDC5C5(const "
    "WIR_Operation&, const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_DDDD_DDDC5(const WIR_Operation&, "
    "const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_DDxDC5_DDxC5C5(const "
    "WIR_Operation&, const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_DDxE_DDxC5C5(const "
    "WIR_Operation&, const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_DDxE_DDxC5C5_2(const "
    "WIR_Operation&, const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR::WIR_Instruction> TC_ConstProp::prop_ExDC5_ExC5C5(const "
    "WIR_Operation&, const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_EDxC5_EC4xC5(const "
    "WIR_Operation&, const WIR_UpDownValue&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_xACBOA_xALBOA(const "
    "WIR_Operation&, const WIR_Symbol&)" );
...
{
  DSTART(
    "list<WIR_Instruction> TC_ConstProp::prop_ACDBOA_ALDBOA(const "
    "WIR_Operation&, const WIR_Symbol&)" );
  ...
  const auto &p3o = o.getExplicitParameters().back().get();
  auto *p3 =
    new WIR_RegisterParameter(
...
{
  DSTART(
    "void TC_ConstProp::patchUsedERegParameter(WIR_Parameter&, const "
    "WIR_Parameter&) const" );
