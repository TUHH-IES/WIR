...
/*!
  ...
  @param bNew A const reference to the new basic block the flow restrictions
              will refer to.
  ...
  @author Til Mauersberger <Til.Mauersberger@tuhh.de>
*/
void replaceBasicBlock( WIR_BasicBlock &b, const WIR_BasicBlock &bNew );
...
/*!
  ...
  @param b A reference to the basic block to be replaced in flow restrictions.
  @param bNew A const reference to the basic block to which flow restrictions
              might refer to, if applicable as replacement.
  ...
  @author Til Mauersberger <Til.Mauersberger@tuhh.de>
*/
void estimateBasicBlock( WIR_BasicBlock &b, const WIR_BasicBlock &bNew );
...
/*!
  ...
  @param bNew A const reference to a basic block to which loop bounds shall be
              moved.
  ...
  @author Til Mauersberger <Til.Mauersberger@tuhh.de>
*/
void moveLoopBounds( WIR_BasicBlock &b, const WIR_BasicBlock &bNew );
...
/*!
  ...
  @param max An integer denoting the maximum number of iterations of the loop.
