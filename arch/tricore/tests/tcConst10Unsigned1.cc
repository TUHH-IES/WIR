...
int main( void )
{
  ...
  TC_Const10_Unsigned p1( 0 );
  TC_Const10_Unsigned p2( 12 );
  TC_Const10_Unsigned p3( 28 );
  ...
  ufAssert( p2.getValue() == 200 );
  ufAssert( p3.getValue() == 996 );
  ...
  auto ref2 = dynamic_cast<TC_Const10_Unsigned &>( ref1 );
  ufAssert( ref2.getValue() == p1.getValue() );

  // Test the copy constructors.
  TC_Const10_Unsigned p4( p1 );
  TC_Const10_Unsigned p5( p2 );
  TC_Const10_Unsigned p6( p3 );
  ...
  ufAssert( p5.getValue() == 200 );
  ufAssert( p6.getValue() == 996 );
  ...
  auto ref4 = dynamic_cast<TC_Const10_Unsigned &>( ref3 );
  ufAssert( ref4.getValue() == p5.getValue() );

  // Test the move constructors.
  TC_Const10_Unsigned p7( std::move( p4 ) );
  TC_Const10_Unsigned p8( std::move( p5 ) );
  TC_Const10_Unsigned p9( std::move( p6 ) );
  ...
  ufAssert( p8.getValue() == 200 );
  ufAssert( p9.getValue() == 996 );
  ...
  auto ref6 = dynamic_cast<TC_Const10_Unsigned &>( ref5 );
  ufAssert( ref6.getValue() == p8.getValue() );

  // Test the copy assignment operator.
  TC_Const10_Unsigned p10( 8 );
  p10 = p1;
  TC_Const10_Unsigned p11( 16 );
  p11 = p2;
  TC_Const10_Unsigned p12( 24 );
  p12 = p3;
  ...
  ufAssert( p11.getValue() == 200 );
  ufAssert( p12.getValue() == 996 );
  ...
  auto ref8 = dynamic_cast<TC_Const10_Unsigned &>( ref7 );
  ufAssert( ref8.getValue() == p10.getValue() );

  // Test the move assignment operator.
  TC_Const10_Unsigned p13( 28 );
  p13 = std::move( p10 );
  TC_Const10_Unsigned p14( 144 );
  p14 = std::move( p11 );
  TC_Const10_Unsigned p15( 360 );
  p15 = std::move( p12 );
  ...
  ufAssert( p14.getValue() == 200 );
  ufAssert( p15.getValue() == 996 );
  ...
  auto ref10 = dynamic_cast<TC_Const10_Unsigned &>( ref9 );
  ufAssert( ref10.getValue() == p14.getValue() );

  // Check legal values for 10 bits wide address parameters that are multiples
  // of 4.
  TC_Const10_Unsigned p16( 0 );
  TC_Const10_Unsigned p17( 40 );
  TC_Const10_Unsigned p18( 112 );
  TC_Const10_Unsigned p19( 888 );
  TC_Const10_Unsigned p20( 1020 );
  p20.setValue( 0 );
  p20.setValue( 40 );
  p20.setValue( 112 );
  p20.setValue( 888 );
