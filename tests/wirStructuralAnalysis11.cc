...
int main( void )
{
  ...
  b1.rbegin()->get().begin()->get().addJumpTarget( b9 );
  ...
  b4.rbegin()->get().begin()->get().addJumpTarget( b7 );

  b5.pushBackInstruction(
    { { MIPS::OpCode::JR, MIPS::OperationFormat::R_2,
        WIR_RegisterParameter( r1, WIR_Usage::use ) } } );
  b5.rbegin()->get().begin()->get().addJumpTarget( b3 );
  b5.rbegin()->get().begin()->get().addJumpTarget( b8 );

  b6.pushBackInstruction(
    { { MIPS::OpCode::JR, MIPS::OperationFormat::R_2,
        WIR_RegisterParameter( r1, WIR_Usage::use ) } } );
  b6.rbegin()->get().begin()->get().addJumpTarget( b10 );

  b7.pushBackInstruction(
    { { MIPS::OpCode::JR, MIPS::OperationFormat::R_2,
        WIR_RegisterParameter( r1, WIR_Usage::use ) } } );
  b7.rbegin()->get().begin()->get().addJumpTarget( b10 );

  b8.pushBackInstruction(
    { { MIPS::OpCode::JR, MIPS::OperationFormat::R_2,
        WIR_RegisterParameter( r1, WIR_Usage::use ) } } );
  b8.rbegin()->get().begin()->get().addJumpTarget( b10 );

  b9.pushBackInstruction(
    { { MIPS::OpCode::JR, MIPS::OperationFormat::R_2,
        WIR_RegisterParameter( r1, WIR_Usage::use ) } } );
  b9.rbegin()->get().begin()->get().addJumpTarget( b10 );
  ...
  auto &switchcase = ipr.getParent();
  ufAssert( switchcase.getType() == WIR_CTNodeType::switchcase );
  ufAssert( switchcase.getEntry() == ipr );
