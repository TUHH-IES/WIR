...
int main( void )
{
  ...
  ufAssert( uval( blt1, 0 ).extract( 0, 31 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( blt1, 0 ).extract( 31, 1 ).containsOnlyBit( WIR_L4::b1 ) );

  ufAssert( uval( blt1, 1 ).extract( 0, 31 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( blt1, 1 ).extract( 31, 1 ).containsOnlyBit( WIR_L4::b0 ) );
