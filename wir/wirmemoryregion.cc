...
WIR_MemoryRegion::WIR_MemoryRegion( WIR_MemoryRegion &&__o ) :
  ...
  mBaseAddress { std::move( __o.mBaseAddress ) },
  mLength { std::move( __o.mLength ) },
  mFreeSpace { std::move( __o.mFreeSpace ) },
  mDynamicAllocation { std::move( __o.mDynamicAllocation ) },
  mAttributes { std::move( __o.mAttributes ) },
  mMemoryType { std::move( __o.mMemoryType ) },
  mClockRatio { std::move( __o.mClockRatio ) },
  mDelay { std::move( __o.mDelay ) },
  mBurstDelay { std::move( __o.mBurstDelay ) },
  mBusWidth { std::move( __o.mBusWidth ) },
  mHierarchyLevels { std::move( __o.mHierarchyLevels ) },
...
WIR_MemoryRegion::WIR_MemoryRegion( std::string &&s ) :
  WIR_SystemComponent { std::move( s ) },
  mBaseAddress { 0 },
  mLength { 0 },
  mFreeSpace { 0 },
  mDynamicAllocation { false },
...
void WIR_MemoryRegion::insertHierarchy( std::list<std::reference_wrapper<WIR_SystemComponent>> &&l )
{
  ...
  for ( const WIR_SystemComponent &c : l )
