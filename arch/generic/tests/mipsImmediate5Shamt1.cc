...
int main( void )
{
  ...
  MIPS_Immediate5_Shamt p1( 0 );
  MIPS_Immediate5_Shamt p2( 1 );
  MIPS_Immediate5_Shamt p3( 23 );
  ...
  auto ref2 = dynamic_cast<MIPS_Immediate5_Shamt &>( ref1 );
  ufAssert( ref2.getValue() == p1.getValue() );

  // Test the copy constructors.
  MIPS_Immediate5_Shamt p4( p1 );
  MIPS_Immediate5_Shamt p5( p2 );
  MIPS_Immediate5_Shamt p6( p3 );
  ...
  auto ref4 = dynamic_cast<MIPS_Immediate5_Shamt &>( ref3 );
  ufAssert( ref4.getValue() == p5.getValue() );

  // Test the move constructors.
  MIPS_Immediate5_Shamt p7( std::move( p4 ) );
  MIPS_Immediate5_Shamt p8( std::move( p5 ) );
  MIPS_Immediate5_Shamt p9( std::move( p6 ) );
  ...
  auto ref6 = dynamic_cast<MIPS_Immediate5_Shamt &>( ref5 );
  ufAssert( ref6.getValue() == p8.getValue() );

  // Test the copy assignment operator.
  MIPS_Immediate5_Shamt p10( 13 );
  p10 = p1;
  MIPS_Immediate5_Shamt p11( 27 );
  p11 = p2;
  MIPS_Immediate5_Shamt p12( 4 );
  p12 = p3;
  ...
  auto ref8 = dynamic_cast<MIPS_Immediate5_Shamt &>( ref7 );
  ufAssert( ref8.getValue() == p10.getValue() );

  // Test the move assignment operator.
  MIPS_Immediate5_Shamt p13( 13 );
  p13 = std::move( p10 );
  MIPS_Immediate5_Shamt p14( 31 );
  p14 = std::move( p11 );
  MIPS_Immediate5_Shamt p15( 9 );
  p15 = std::move( p12 );
  ...
  auto ref10 = dynamic_cast<MIPS_Immediate5_Shamt &>( ref9 );
  ufAssert( ref10.getValue() == p14.getValue() );

  // Check min/max unsigned value for 5 bits.
  MIPS_Immediate5_Shamt p16( 0 );
  MIPS_Immediate5_Shamt p17( 31 );
