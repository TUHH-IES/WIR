...
int main( void )
{
  ...
  TC_Const4_Unsigned p1( 0 );
  TC_Const4_Unsigned p2( 12 );
  TC_Const4_Unsigned p3( 7 );
  ...
  ufAssert( p1.getValue() == 9 );
  ufAssert( p2.getValue() == 14 );
  ufAssert( p3.getValue() == 2 );

  ufAssert( !p1.isSigned() );
  ufAssert( p1.isUnsigned() );
  ufAssert( p1.getBitWidth() == 4 );
  ...
  auto ref2 = dynamic_cast<TC_Const4_Unsigned &>( ref1 );
  ufAssert( ref2.getValue() == p1.getValue() );

  // Test the copy constructors.
  TC_Const4_Unsigned p4( p1 );
  TC_Const4_Unsigned p5( p2 );
  TC_Const4_Unsigned p6( p3 );

  ufAssert( p4.getType() == WIR_ParameterType::imm );
  ufAssert( p4.getType() == p5.getType() );
  ufAssert( p5.getType() == p6.getType() );

  ufAssert( p4.getValue() == 9 );
  ufAssert( p5.getValue() == 14 );
  ufAssert( p6.getValue() == 2 );

  ufAssert( !p4.isSigned() );
  ufAssert( p4.isUnsigned() );
  ufAssert( p4.getBitWidth() == 4 );
  ...
  auto ref4 = dynamic_cast<TC_Const4_Unsigned &>( ref3 );
  ufAssert( ref4.getValue() == p5.getValue() );

  // Test the move constructors.
  TC_Const4_Unsigned p7( std::move( p4 ) );
  TC_Const4_Unsigned p8( std::move( p5 ) );
  TC_Const4_Unsigned p9( std::move( p6 ) );

  ufAssert( p7.getType() == WIR_ParameterType::imm );
  ufAssert( p7.getType() == p8.getType() );
  ufAssert( p8.getType() == p9.getType() );

  ufAssert( p7.getValue() == 9 );
  ufAssert( p8.getValue() == 14 );
  ufAssert( p9.getValue() == 2 );
  ...
  auto ref6 = dynamic_cast<TC_Const4_Unsigned &>( ref5 );
  ufAssert( ref6.getValue() == p8.getValue() );

  // Test the copy assignment operator.
  TC_Const4_Unsigned p10( 1 );
  p10 = p1;
  TC_Const4_Unsigned p11( 2 );
  p11 = p2;
  TC_Const4_Unsigned p12( 3 );
  p12 = p3;
  ...
  ufAssert( p10.getValue() == 9 );
  ufAssert( p11.getValue() == 14 );
  ufAssert( p12.getValue() == 2 );

  ufAssert( !p10.isSigned() );
  ufAssert( p10.isUnsigned() );
  ufAssert( p10.getBitWidth() == 4 );
  ...
  auto ref8 = dynamic_cast<TC_Const4_Unsigned &>( ref7 );
  ufAssert( ref8.getValue() == p10.getValue() );

  // Test the move assignment operator.
  TC_Const4_Unsigned p13( 4 );
  p13 = std::move( p10 );
  TC_Const4_Unsigned p14( 5 );
  p14 = std::move( p11 );
  TC_Const4_Unsigned p15( 6 );
  p15 = std::move( p12 );
  ...
  ufAssert( p13.getValue() == 9 );
  ufAssert( p14.getValue() == 14 );
  ufAssert( p15.getValue() == 2 );
  ...
  auto ref10 = dynamic_cast<TC_Const4_Unsigned &>( ref9 );
  ufAssert( ref10.getValue() == p14.getValue() );

  // Check min/max unsigned value for 4 bits.
  TC_Const4_Unsigned p16( 0 );
  TC_Const4_Unsigned p17( 15 );
