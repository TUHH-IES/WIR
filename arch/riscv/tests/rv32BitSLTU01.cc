...
int main( void )
{
  ...
  ufAssert( uval( sltu1, 1 ).extract( 0, 32 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( dval( sltu1, 0 ).extract( 0, 32 ).getSignedValue() == 1 );

  ufAssert( uval( sltu2, 1 ).extract( 0, 32 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( dval( sltu2, 0 ).extract( 0, 32 ).getSignedValue() == 0 );

  ufAssert( uval( sltu3, 1 ).extract( 0, 32 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( dval( sltu3, 0 ).extract( 0, 32 ).getSignedValue() == 0 );

  ufAssert( uval( sltu4, 1 ).extract( 0, 32 ).getSignedValue() == 30 );
  ufAssert( dval( sltu4, 0 ).extract( 0, 32 ).getSignedValue() == 1 );

  ufAssert( uval( sltu5, 1 ).extract( 0, 32 ).getSignedValue() == 1 );
  ufAssert( dval( sltu5, 0 ).extract( 0, 32 ).getSignedValue() == 0 );

  ufAssert( uval( sltu6, 1 ).extract( 0, 32 ).getSignedValue() == 0 );
  ufAssert( dval( sltu6, 0 ).extract( 0, 32 ).getSignedValue() == 0 );
