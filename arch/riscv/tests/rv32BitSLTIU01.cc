...
int main( void )
{
  ...
  ufAssert( uval( sltiu1, 1 ).extract( 0, 32 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( dval( sltiu1, 0 ).extract( 0, 32 ).getSignedValue() == 1 );

  ufAssert( uval( sltiu2, 1 ).extract( 0, 32 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( dval( sltiu2, 0 ).extract( 0, 32 ).getSignedValue() == 0 );

  ufAssert( uval( sltiu3, 1 ).extract( 0, 32 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( dval( sltiu3, 0 ).extract( 0, 32 ).getSignedValue() == 0 );

  ufAssert( uval( sltiu4, 1 ).extract( 0, 32 ).getSignedValue() == 30 );
  ufAssert( dval( sltiu4, 0 ).extract( 0, 32 ).getSignedValue() == 1 );

  ufAssert( uval( sltiu5, 1 ).extract( 0, 32 ).getSignedValue() == 1 );
  ufAssert( dval( sltiu5, 0 ).extract( 0, 32 ).getSignedValue() == 0 );

  ufAssert( uval( sltiu6, 1 ).extract( 0, 32 ).getSignedValue() == 0 );
  ufAssert( dval( sltiu6, 0 ).extract( 0, 32 ).getSignedValue() == 0 );

  ufAssert( uval( sltiu7, 1 ).extract( 0, 32 ).getSignedValue() == 0 );
  ufAssert( dval( sltiu7, 0 ).extract( 0, 32 ).getSignedValue() == 1 );
