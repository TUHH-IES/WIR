...
/*!
  @brief Class ARMv4 models the general ARM architecture.

  Since the old architecture versions ARMv1x, ARMv2x and ARMv3x are deprecated,
  this class ARMv4 actually models the ARMv4 architecture.
...
class ARMv4 : public WIR_Processor<ARMv4>
{
  ...
  public:
    ...
    class AddressingMode : public WIR_Processor::AddressingMode
    {
      ...
      public:
        ...
        /*!
          ...
          @author Heiko Falk <Heiko.Falk@tuhh.de>
        */
        virtual std::string getProcessorTypeName( void ) const override;
        ...
        */
        virtual bool isCompatible( const WIR_BaseProcessor::AddressingMode &,
                                   ...
                                   const WIR_BaseProcessor::OpCode & ) const override;
    ...
    */
    ...
    /*!
      @brief boolBytes contains the width of a _Bool in bytes for the ARMv4
             architecture.
    */
    static const int boolBytes = ( 8 / 8 );

    /*!
      @brief charBytes contains the width of a _char in bytes for the ARMv4
             architecture.
    */
    static const int charBytes = ( 8 / 8 );

    /*!
      @brief shortBytes contains the width of a short in bytes for the ARMv4
             architecture.
    */
    static const int shortBytes = ( 16 / 8 );

    /*!
      @brief intBytes contains the width of an int in bytes for the ARMv4
             architecture.
    */
    static const int intBytes = ( 32 / 8 );

    /*!
      @brief longBytes contains the width of a long in bytes for the ARMv4
             architecture.
    */
    ...
    */
    ...
    /*!
      @brief pointerBytes contains the width of a pointer in bytes for the ARMv4
             architecture.
    */
    static const int pointerBytes = ( 32 / 8 );

    /*!
      @brief floatBytes contains the width of a float in bytes for the ARMv4
             architecture.
    */
    static const int floatBytes = ( 32 / 8 );

    /*!
      @brief doubleBytes contains the width of a double in bytes for the ARMv4
             architecture.
    */
    ...
    /*!
      @brief longDoubleBytes contains the width of a long double in bytes for the
             ARMv4 architecture.
    */
    static const int longDoubleBytes = ( 64 / 8 );
