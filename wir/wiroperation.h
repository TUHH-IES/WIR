                            ...
                            public WIR_Container_API
{
  ...
  public:
    ...
    */
    ...
    /*!
      @brief isImplicitMemoryAccess returns whether an operation implicitly
             accesses memory without being an explicit load or store operation.

      @return true if the operation implicitly accesses memory, false otherwise.

      @author Heiko Falk <Heiko.Falk@tuhh.de>
    */
    bool isImplicitMemoryAccess( void ) const;
