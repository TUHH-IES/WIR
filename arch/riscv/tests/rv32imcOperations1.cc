...
int main( void )
{
  ...
  ufAssert(
    !add1.isImplicitMemoryAccess() && !add1.isMemoryStore() &&
    !add1.isMemoryLoad() && !add1.isMove() && !add1.isCall() &&
    !add1.isIndirectCall() && !add1.isReturn() && !add1.isJump() &&
    !add1.isConditionalJump() && !add1.isUnconditionalJump() &&
    !add1.isIndirectJump() && !add1.isAsmDataDirective() &&
    !add1.hasSideEffects() );
  ...
  ufAssert(
    !addi2.isImplicitMemoryAccess() && !addi2.isMemoryStore() &&
  ...
  ufAssert(
    !andi1.isImplicitMemoryAccess() && !andi1.isMemoryStore() &&
  ...
  ufAssert(
    !andi2.isImplicitMemoryAccess() && !andi2.isMemoryStore() &&
  ...
  ufAssert(
    !auipc1.isImplicitMemoryAccess() && !auipc1.isMemoryStore() &&
  ...
  ufAssert(
    !auipc2.isImplicitMemoryAccess() && !auipc2.isMemoryStore() &&
  ...
  ufAssert(
    !beq1.isImplicitMemoryAccess() && !beq1.isMemoryStore() &&
    !beq1.isMemoryLoad() && !beq1.isMove() && !beq1.isCall() &&
    !beq1.isIndirectCall() && !beq1.isReturn() && beq1.isJump() &&
    beq1.isConditionalJump() && !beq1.isUnconditionalJump() &&
    !beq1.isIndirectJump() && !beq1.isAsmDataDirective() &&
    !beq1.hasSideEffects() );
  ...
  ufAssert(
    !bge1.isImplicitMemoryAccess() && !bge1.isMemoryStore() &&
    !bge1.isMemoryLoad() && !bge1.isMove() && !bge1.isCall() &&
    !bge1.isIndirectCall() && !bge1.isReturn() && bge1.isJump() &&
    bge1.isConditionalJump() && !bge1.isUnconditionalJump() &&
    !bge1.isIndirectJump() && !bge1.isAsmDataDirective() &&
    !bge1.hasSideEffects() );
  ...
  ufAssert(
    !bgeu1.isImplicitMemoryAccess() && !bgeu1.isMemoryStore() &&
  ...
  ufAssert(
    !blt1.isImplicitMemoryAccess() && !blt1.isMemoryStore() &&
    !blt1.isMemoryLoad() && !blt1.isMove() && !blt1.isCall() &&
    !blt1.isIndirectCall() && !blt1.isReturn() && blt1.isJump() &&
    blt1.isConditionalJump() && !blt1.isUnconditionalJump() &&
    !blt1.isIndirectJump() && !blt1.isAsmDataDirective() &&
    !blt1.hasSideEffects() );
  ...
  ufAssert(
    !bltu1.isImplicitMemoryAccess() && !bltu1.isMemoryStore() &&
  ...
  ufAssert(
    !bne1.isImplicitMemoryAccess() && !bne1.isMemoryStore() &&
    !bne1.isMemoryLoad() && !bne1.isMove() && !bne1.isCall() &&
    !bne1.isIndirectCall() && !bne1.isReturn() && bne1.isJump() &&
    bne1.isConditionalJump() && !bne1.isUnconditionalJump() &&
    !bne1.isIndirectJump() && !bne1.isAsmDataDirective() &&
    !bne1.hasSideEffects() );
  ...
  ufAssert(
    !csrrc1.isImplicitMemoryAccess() && !csrrc1.isMemoryStore() &&
  ...
  ufAssert(
    !csrrc2.isImplicitMemoryAccess() && !csrrc2.isMemoryStore() &&
  ...
  ufAssert(
    !csrrc3.isImplicitMemoryAccess() && !csrrc3.isMemoryStore() &&
  ...
  ufAssert(
    !csrrc4.isImplicitMemoryAccess() && !csrrc4.isMemoryStore() &&
  ...
  ufAssert(
    !csrrc5.isImplicitMemoryAccess() && !csrrc5.isMemoryStore() &&
  ...
  ufAssert(
    !csrrc6.isImplicitMemoryAccess() && !csrrc6.isMemoryStore() &&
  ...
  ufAssert(
    !csrrc7.isImplicitMemoryAccess() && !csrrc7.isMemoryStore() &&
  ...
  ufAssert(
    !csrrc8.isImplicitMemoryAccess() && !csrrc8.isMemoryStore() &&
  ...
  ufAssert(
    !csrrc9.isImplicitMemoryAccess() && !csrrc9.isMemoryStore() &&
  ...
  ufAssert(
    !csrrci1.isImplicitMemoryAccess() && !csrrci1.isMemoryStore() &&
  ...
  ufAssert(
    !csrrci2.isImplicitMemoryAccess() && !csrrci2.isMemoryStore() &&
  ...
  ufAssert(
    !csrrci3.isImplicitMemoryAccess() && !csrrci3.isMemoryStore() &&
  ...
  ufAssert(
    !csrrci4.isImplicitMemoryAccess() && !csrrci4.isMemoryStore() &&
  ...
  ufAssert(
    !csrrci5.isImplicitMemoryAccess() && !csrrci5.isMemoryStore() &&
  ...
  ufAssert(
    !csrrci6.isImplicitMemoryAccess() && !csrrci6.isMemoryStore() &&
  ...
  ufAssert(
    !csrrci7.isImplicitMemoryAccess() && !csrrci7.isMemoryStore() &&
  ...
  ufAssert(
    !csrrci8.isImplicitMemoryAccess() && !csrrci8.isMemoryStore() &&
  ...
  ufAssert(
    !csrrci9.isImplicitMemoryAccess() && !csrrci9.isMemoryStore() &&
  ...
  ufAssert(
    !csrrs1.isImplicitMemoryAccess() && !csrrs1.isMemoryStore() &&
  ...
  ufAssert(
    !csrrs2.isImplicitMemoryAccess() && !csrrs2.isMemoryStore() &&
  ...
  ufAssert(
    !csrrs3.isImplicitMemoryAccess() && !csrrs3.isMemoryStore() &&
  ...
  ufAssert(
    !csrrs4.isImplicitMemoryAccess() && !csrrs4.isMemoryStore() &&
  ...
  ufAssert(
    !csrrs5.isImplicitMemoryAccess() && !csrrs5.isMemoryStore() &&
  ...
  ufAssert(
    !csrrs6.isImplicitMemoryAccess() && !csrrs6.isMemoryStore() &&
  ...
  ufAssert(
    !csrrs7.isImplicitMemoryAccess() && !csrrs7.isMemoryStore() &&
  ...
  ufAssert(
    !csrrs8.isImplicitMemoryAccess() && !csrrs8.isMemoryStore() &&
  ...
  ufAssert(
    !csrrs9.isImplicitMemoryAccess() && !csrrs9.isMemoryStore() &&
  ...
  ufAssert(
    !csrrsi1.isImplicitMemoryAccess() && !csrrsi1.isMemoryStore() &&
  ...
  ufAssert(
    !csrrsi2.isImplicitMemoryAccess() && !csrrsi2.isMemoryStore() &&
  ...
  ufAssert(
    !csrrsi3.isImplicitMemoryAccess() && !csrrsi3.isMemoryStore() &&
  ...
  ufAssert(
    !csrrsi4.isImplicitMemoryAccess() && !csrrsi4.isMemoryStore() &&
  ...
  ufAssert(
    !csrrsi5.isImplicitMemoryAccess() && !csrrsi5.isMemoryStore() &&
  ...
  ufAssert(
    !csrrsi6.isImplicitMemoryAccess() && !csrrsi6.isMemoryStore() &&
  ...
  ufAssert(
    !csrrsi7.isImplicitMemoryAccess() && !csrrsi7.isMemoryStore() &&
  ...
  ufAssert(
    !csrrsi8.isImplicitMemoryAccess() && !csrrsi8.isMemoryStore() &&
  ...
  ufAssert(
    !csrrsi9.isImplicitMemoryAccess() && !csrrsi9.isMemoryStore() &&
  ...
  ufAssert(
    !csrrw1.isImplicitMemoryAccess() && !csrrw1.isMemoryStore() &&
  ...
  ufAssert(
    !csrrw2.isImplicitMemoryAccess() && !csrrw2.isMemoryStore() &&
  ...
  ufAssert(
    !csrrw3.isImplicitMemoryAccess() && !csrrw3.isMemoryStore() &&
  ...
  ufAssert(
    !csrrw4.isImplicitMemoryAccess() && !csrrw4.isMemoryStore() &&
  ...
  ufAssert(
    !csrrw5.isImplicitMemoryAccess() && !csrrw5.isMemoryStore() &&
  ...
  ufAssert(
    !csrrw6.isImplicitMemoryAccess() && !csrrw6.isMemoryStore() &&
  ...
  ufAssert(
    !csrrw7.isImplicitMemoryAccess() && !csrrw7.isMemoryStore() &&
  ...
  ufAssert(
    !csrrw8.isImplicitMemoryAccess() && !csrrw8.isMemoryStore() &&
  ...
  ufAssert(
    !csrrw9.isImplicitMemoryAccess() && !csrrw9.isMemoryStore() &&
  ...
  ufAssert(
    !csrrwi1.isImplicitMemoryAccess() && !csrrwi1.isMemoryStore() &&
  ...
  ufAssert(
    !csrrwi2.isImplicitMemoryAccess() && !csrrwi2.isMemoryStore() &&
  ...
  ufAssert(
    !csrrwi3.isImplicitMemoryAccess() && !csrrwi3.isMemoryStore() &&
  ...
  ufAssert(
    !csrrwi4.isImplicitMemoryAccess() && !csrrwi4.isMemoryStore() &&
  ...
  ufAssert(
    !csrrwi5.isImplicitMemoryAccess() && !csrrwi5.isMemoryStore() &&
  ...
  ufAssert(
    !csrrwi6.isImplicitMemoryAccess() && !csrrwi6.isMemoryStore() &&
  ...
  ufAssert(
    !csrrwi7.isImplicitMemoryAccess() && !csrrwi7.isMemoryStore() &&
  ...
  ufAssert(
    !csrrwi8.isImplicitMemoryAccess() && !csrrwi8.isMemoryStore() &&
  ...
  ufAssert(
    !csrrwi9.isImplicitMemoryAccess() && !csrrwi9.isMemoryStore() &&
  ...
  ufAssert(
    !ebreak1.isImplicitMemoryAccess() && !ebreak1.isMemoryStore() &&
  ...
  ufAssert(
    !ecall1.isImplicitMemoryAccess() && !ecall1.isMemoryStore() &&
  ...
  ufAssert(
    !j1.isImplicitMemoryAccess() && !j1.isMemoryStore() && !j1.isMemoryLoad() &&
  ...
  ufAssert(
    !jal1.isImplicitMemoryAccess() && !jal1.isMemoryStore() &&
    !jal1.isMemoryLoad() && !jal1.isMove() && jal1.isCall() &&
    !jal1.isIndirectCall() && !jal1.isReturn() && !jal1.isJump() &&
    !jal1.isConditionalJump() && !jal1.isUnconditionalJump() &&
    !jal1.isIndirectJump() && !jal1.isAsmDataDirective() &&
    !jal1.hasSideEffects() );
  ...
  ufAssert(
    !jalr1.isImplicitMemoryAccess() && !jalr1.isMemoryStore() &&
  ...
  ufAssert(
    !jalr2.isImplicitMemoryAccess() && !jalr2.isMemoryStore() &&
  ...
  ufAssert(
    !jalr3.isImplicitMemoryAccess() && !jalr3.isMemoryStore() &&
  ...
  ufAssert(
    !jalr4.isImplicitMemoryAccess() && !jalr4.isMemoryStore() &&
    !jalr4.isMemoryLoad() && !jalr4.isMove() && !jalr4.isCall() &&
    jalr4.isIndirectCall() && !jalr4.isReturn() && !jalr4.isJump() &&
    !jalr4.isConditionalJump() && !jalr4.isUnconditionalJump() &&
    !jalr4.isIndirectJump() && !jalr4.isAsmDataDirective() &&
    !jalr4.hasSideEffects() );
  ...
  ufAssert(
    !jr1.isImplicitMemoryAccess() && !jr1.isMemoryStore() &&
    !jr1.isMemoryLoad() && !jr1.isMove() && !jr1.isCall() &&
    !jr1.isIndirectCall() && !jr1.isReturn() && jr1.isJump() &&
    !jr1.isConditionalJump() && !jr1.isUnconditionalJump() &&
    jr1.isIndirectJump() && !jr1.isAsmDataDirective() &&
    !jr1.hasSideEffects() );
  ...
  ufAssert(
    !lb1.isImplicitMemoryAccess() && !lb1.isMemoryStore() &&
    lb1.isMemoryLoad() && !lb1.isMove() && !lb1.isCall() &&
    !lb1.isIndirectCall() && !lb1.isReturn() && !lb1.isJump() &&
    !lb1.isConditionalJump() && !lb1.isUnconditionalJump() &&
    !lb1.isIndirectJump() && !lb1.isAsmDataDirective() &&
    !lb1.hasSideEffects() );
  ...
  ufAssert(
    !lb2.isImplicitMemoryAccess() && !lb2.isMemoryStore() &&
    lb2.isMemoryLoad() && !lb2.isMove() && !lb2.isCall() &&
    !lb2.isIndirectCall() && !lb2.isReturn() && !lb2.isJump() &&
    !lb2.isConditionalJump() && !lb2.isUnconditionalJump() &&
    !lb2.isIndirectJump() && !lb2.isAsmDataDirective() &&
    !lb2.hasSideEffects() );
  ...
  ufAssert(
    !lbu1.isImplicitMemoryAccess() && !lbu1.isMemoryStore() &&
    lbu1.isMemoryLoad() && !lbu1.isMove() && !lbu1.isCall() &&
    !lbu1.isIndirectCall() && !lbu1.isReturn() && !lbu1.isJump() &&
    !lbu1.isConditionalJump() && !lbu1.isUnconditionalJump() &&
    !lbu1.isIndirectJump() && !lbu1.isAsmDataDirective() &&
    !lbu1.hasSideEffects() );
  ...
  ufAssert(
    !lbu2.isImplicitMemoryAccess() && !lbu2.isMemoryStore() &&
    lbu2.isMemoryLoad() && !lbu2.isMove() && !lbu2.isCall() &&
    !lbu2.isIndirectCall() && !lbu2.isReturn() && !lbu2.isJump() &&
    !lbu2.isConditionalJump() && !lbu2.isUnconditionalJump() &&
    !lbu2.isIndirectJump() && !lbu2.isAsmDataDirective() &&
    !lbu2.hasSideEffects() );
  ...
  ufAssert(
    !lh1.isImplicitMemoryAccess() && !lh1.isMemoryStore() &&
    lh1.isMemoryLoad() && !lh1.isMove() && !lh1.isCall() &&
    !lh1.isIndirectCall() && !lh1.isReturn() && !lh1.isJump() &&
    !lh1.isConditionalJump() && !lh1.isUnconditionalJump() &&
    !lh1.isIndirectJump() && !lh1.isAsmDataDirective() &&
    !lh1.hasSideEffects() );
  ...
  ufAssert(
    !lh2.isImplicitMemoryAccess() && !lh2.isMemoryStore() &&
    lh2.isMemoryLoad() && !lh2.isMove() && !lh2.isCall() &&
    !lh2.isIndirectCall() && !lh2.isReturn() && !lh2.isJump() &&
    !lh2.isConditionalJump() && !lh2.isUnconditionalJump() &&
    !lh2.isIndirectJump() && !lh2.isAsmDataDirective() &&
    !lh2.hasSideEffects() );
  ...
  ufAssert(
    !lhu1.isImplicitMemoryAccess() && !lhu1.isMemoryStore() &&
    lhu1.isMemoryLoad() && !lhu1.isMove() && !lhu1.isCall() &&
    !lhu1.isIndirectCall() && !lhu1.isReturn() && !lhu1.isJump() &&
    !lhu1.isConditionalJump() && !lhu1.isUnconditionalJump() &&
    !lhu1.isIndirectJump() && !lhu1.isAsmDataDirective() &&
    !lhu1.hasSideEffects() );
  ...
  ufAssert(
    !lhu2.isImplicitMemoryAccess() && !lhu2.isMemoryStore() &&
    lhu2.isMemoryLoad() && !lhu2.isMove() && !lhu2.isCall() &&
    !lhu2.isIndirectCall() && !lhu2.isReturn() && !lhu2.isJump() &&
    !lhu2.isConditionalJump() && !lhu2.isUnconditionalJump() &&
    !lhu2.isIndirectJump() && !lhu2.isAsmDataDirective() &&
    !lhu2.hasSideEffects() );
  ...
  ufAssert(
    !lui1.isImplicitMemoryAccess() && !lui1.isMemoryStore() &&
    !lui1.isMemoryLoad() && !lui1.isMove() && !lui1.isCall() &&
    !lui1.isIndirectCall() && !lui1.isReturn() && !lui1.isJump() &&
    !lui1.isConditionalJump() && !lui1.isUnconditionalJump() &&
    !lui1.isIndirectJump() && !lui1.isAsmDataDirective() &&
    !lui1.hasSideEffects() );
  ...
  ufAssert(
    !lui2.isImplicitMemoryAccess() && !lui2.isMemoryStore() &&
    !lui2.isMemoryLoad() && !lui2.isMove() && !lui2.isCall() &&
    !lui2.isIndirectCall() && !lui2.isReturn() && !lui2.isJump() &&
    !lui2.isConditionalJump() && !lui2.isUnconditionalJump() &&
    !lui2.isIndirectJump() && !lui2.isAsmDataDirective() &&
    !lui2.hasSideEffects() );
  ...
  ufAssert(
    !lw1.isImplicitMemoryAccess() && !lw1.isMemoryStore() &&
    lw1.isMemoryLoad() && !lw1.isMove() && !lw1.isCall() &&
    !lw1.isIndirectCall() && !lw1.isReturn() && !lw1.isJump() &&
    !lw1.isConditionalJump() && !lw1.isUnconditionalJump() &&
    !lw1.isIndirectJump() && !lw1.isAsmDataDirective() &&
    !lw1.hasSideEffects() );
  ...
  ufAssert(
    !lw2.isImplicitMemoryAccess() && !lw2.isMemoryStore() &&
    lw2.isMemoryLoad() && !lw2.isMove() && !lw2.isCall() &&
    !lw2.isIndirectCall() && !lw2.isReturn() && !lw2.isJump() &&
    !lw2.isConditionalJump() && !lw2.isUnconditionalJump() &&
    !lw2.isIndirectJump() && !lw2.isAsmDataDirective() &&
    !lw2.hasSideEffects() );
  ...
  ufAssert(
    !mov.isImplicitMemoryAccess() && !mov.isMemoryStore() &&
  ...
  ufAssert(
    !ori1.isImplicitMemoryAccess() && !ori1.isMemoryStore() &&
    !ori1.isMemoryLoad() && !ori1.isMove() && !ori1.isCall() &&
    !ori1.isIndirectCall() && !ori1.isReturn() && !ori1.isJump() &&
    !ori1.isConditionalJump() && !ori1.isUnconditionalJump() &&
    !ori1.isIndirectJump() && !ori1.isAsmDataDirective() &&
    !ori1.hasSideEffects() );
  ...
  ufAssert(
    !ori2.isImplicitMemoryAccess() && !ori2.isMemoryStore() &&
    !ori2.isMemoryLoad() && !ori2.isMove() && !ori2.isCall() &&
    !ori2.isIndirectCall() && !ori2.isReturn() && !ori2.isJump() &&
    !ori2.isConditionalJump() && !ori2.isUnconditionalJump() &&
    !ori2.isIndirectJump() && !ori2.isAsmDataDirective() &&
    !ori2.hasSideEffects() );
  ...
  ufAssert(
    !sb1.isImplicitMemoryAccess() && sb1.isMemoryStore() &&
    !sb1.isMemoryLoad() && !sb1.isMove() && !sb1.isCall() &&
    !sb1.isIndirectCall() && !sb1.isReturn() && !sb1.isJump() &&
    !sb1.isConditionalJump() && !sb1.isUnconditionalJump() &&
    !sb1.isIndirectJump() && !sb1.isAsmDataDirective() &&
    !sb1.hasSideEffects() );
  ...
  ufAssert(
    !sb2.isImplicitMemoryAccess() && sb2.isMemoryStore() &&
    !sb2.isMemoryLoad() && !sb2.isMove() && !sb2.isCall() &&
    !sb2.isIndirectCall() && !sb2.isReturn() && !sb2.isJump() &&
    !sb2.isConditionalJump() && !sb2.isUnconditionalJump() &&
    !sb2.isIndirectJump() && !sb2.isAsmDataDirective() &&
    !sb2.hasSideEffects() );
  ...
  ufAssert(
    !sh2.isImplicitMemoryAccess() && sh2.isMemoryStore() &&
    !sh2.isMemoryLoad() && !sh2.isMove() && !sh2.isCall() &&
    !sh2.isIndirectCall() && !sh2.isReturn() && !sh2.isJump() &&
    !sh2.isConditionalJump() && !sh2.isUnconditionalJump() &&
    !sh2.isIndirectJump() && !sh2.isAsmDataDirective() &&
    !sh2.hasSideEffects() );
  ...
  ufAssert(
    !sll1.isImplicitMemoryAccess() && !sll1.isMemoryStore() &&
    !sll1.isMemoryLoad() && !sll1.isMove() && !sll1.isCall() &&
    !sll1.isIndirectCall() && !sll1.isReturn() && !sll1.isJump() &&
    !sll1.isConditionalJump() && !sll1.isUnconditionalJump() &&
    !sll1.isIndirectJump() && !sll1.isAsmDataDirective() &&
    !sll1.hasSideEffects() );
  ...
  ufAssert(
    !slli1.isImplicitMemoryAccess() && !slli1.isMemoryStore() &&
  ...
  ufAssert(
    !slt1.isImplicitMemoryAccess() && !slt1.isMemoryStore() &&
    !slt1.isMemoryLoad() && !slt1.isMove() && !slt1.isCall() &&
    !slt1.isIndirectCall() && !slt1.isReturn() && !slt1.isJump() &&
    !slt1.isConditionalJump() && !slt1.isUnconditionalJump() &&
    !slt1.isIndirectJump() && !slt1.isAsmDataDirective() &&
    !slt1.hasSideEffects() );
  ...
  ufAssert(
    !slti1.isImplicitMemoryAccess() && !slti1.isMemoryStore() &&
  ...
  ufAssert(
    !slti2.isImplicitMemoryAccess() && !slti2.isMemoryStore() &&
  ...
  ufAssert(
    !sltiu1.isImplicitMemoryAccess() && !sltiu1.isMemoryStore() &&
  ...
  ufAssert(
    !sltiu2.isImplicitMemoryAccess() && !sltiu2.isMemoryStore() &&
  ...
  ufAssert(
    !sltu1.isImplicitMemoryAccess() && !sltu1.isMemoryStore() &&
  ...
  ufAssert(
    !sra1.isImplicitMemoryAccess() && !sra1.isMemoryStore() &&
    !sra1.isMemoryLoad() && !sra1.isMove() && !sra1.isCall() &&
    !sra1.isIndirectCall() && !sra1.isReturn() && !sra1.isJump() &&
    !sra1.isConditionalJump() && !sra1.isUnconditionalJump() &&
    !sra1.isIndirectJump() && !sra1.isAsmDataDirective() &&
    !sra1.hasSideEffects() );
  ...
  ufAssert(
    !srai1.isImplicitMemoryAccess() && !srai1.isMemoryStore() &&
  ...
  ufAssert(
    !srl1.isImplicitMemoryAccess() && !srl1.isMemoryStore() &&
    !srl1.isMemoryLoad() && !srl1.isMove() && !srl1.isCall() &&
    !srl1.isIndirectCall() && !srl1.isReturn() && !srl1.isJump() &&
    !srl1.isConditionalJump() && !srl1.isUnconditionalJump() &&
    !srl1.isIndirectJump() && !srl1.isAsmDataDirective() &&
    !srl1.hasSideEffects() );
  ...
  ufAssert(
    !srli1.isImplicitMemoryAccess() && !srli1.isMemoryStore() &&
  ...
  ufAssert(
    !sw1.isImplicitMemoryAccess() && sw1.isMemoryStore() &&
    !sw1.isMemoryLoad() && !sw1.isMove() && !sw1.isCall() &&
    !sw1.isIndirectCall() && !sw1.isReturn() && !sw1.isJump() &&
    !sw1.isConditionalJump() && !sw1.isUnconditionalJump() &&
    !sw1.isIndirectJump() && !sw1.isAsmDataDirective() &&
    !sw1.hasSideEffects() );
  ...
  ufAssert(
    !sw2.isImplicitMemoryAccess() && sw2.isMemoryStore() &&
    !sw2.isMemoryLoad() && !sw2.isMove() && !sw2.isCall() &&
    !sw2.isIndirectCall() && !sw2.isReturn() && !sw2.isJump() &&
    !sw2.isConditionalJump() && !sw2.isUnconditionalJump() &&
    !sw2.isIndirectJump() && !sw2.isAsmDataDirective() &&
    !sw2.hasSideEffects() );
  ...
  ufAssert(
    !xori1.isImplicitMemoryAccess() && !xori1.isMemoryStore() &&
  ...
  ufAssert(
    !xori2.isImplicitMemoryAccess() && !xori2.isMemoryStore() &&
  ...
  WIR_Operation caddi1(
    RV32IMC::OpCode::CADDI, RV32IMC::OperationFormat::SRC6_2,
    new WIR_RegisterParameter( x1, WIR_Usage::defuse ),
    new RV_Const6_Signed( -10 ) );
  ufAssert( caddi1.getSize() == 2 );
  ufAssert(
    !caddi1.isImplicitMemoryAccess() && !caddi1.isMemoryStore() &&
  ...
  WIR_Operation caddi16sp1(
    RV32IMC::OpCode::CADDI16SP, RV32IMC::OperationFormat::SRC10_1,
    new WIR_RegisterParameter( riscv.x2(), WIR_Usage::defuse ),
    new RV_Const10_Signed( -16 ) );
  ufAssert( caddi16sp1.getSize() == 2 );
  ufAssert(
    !caddi16sp1.isImplicitMemoryAccess() && !caddi16sp1.isMemoryStore() &&
    !caddi16sp1.isMemoryLoad() && !caddi16sp1.isMove() &&
    !caddi16sp1.isCall() && !caddi16sp1.isIndirectCall() &&
    !caddi16sp1.isReturn() && !caddi16sp1.isJump() &&
  ...
  WIR_Operation caddi4spn1(
    RV32IMC::OpCode::CADDI4SPN, RV32IMC::OperationFormat::SRRC10_1,
    new WIR_RegisterParameter( x1, WIR_Usage::def ),
    new WIR_RegisterParameter( riscv.x2(), WIR_Usage::use ),
    new RV_Const10_Unsigned( 8 ) );
  ufAssert( caddi4spn1.getSize() == 2 );
  ufAssert(
    !caddi4spn1.isImplicitMemoryAccess() && !caddi4spn1.isMemoryStore() &&
    !caddi4spn1.isMemoryLoad() && !caddi4spn1.isMove() &&
    !caddi4spn1.isCall() && !caddi4spn1.isIndirectCall() &&
    !caddi4spn1.isReturn() && !caddi4spn1.isJump() &&
  ...
  ufAssert(
    !cand1.isImplicitMemoryAccess() && !cand1.isMemoryStore() &&
  ...
  WIR_Operation candi1(
    RV32IMC::OpCode::CANDI, RV32IMC::OperationFormat::SRC6_2,
    new WIR_RegisterParameter( x1, WIR_Usage::defuse ),
    new RV_Const6_Signed( -10 ) );
  ufAssert( candi1.getSize() == 2 );
  ufAssert(
    !candi1.isImplicitMemoryAccess() && !candi1.isMemoryStore() &&
  ...
  ufAssert(
    !cbeqz1.isImplicitMemoryAccess() && !cbeqz1.isMemoryStore() &&
  ...
  ufAssert(
    !cbnez1.isImplicitMemoryAccess() && !cbnez1.isMemoryStore() &&
  ...
  ufAssert(
    !cebreak1.isImplicitMemoryAccess() && !cebreak1.isMemoryStore() &&
  ...
  ufAssert(
    !cj1.isImplicitMemoryAccess() && !cj1.isMemoryStore() &&
    !cj1.isMemoryLoad() && !cj1.isMove() && !cj1.isCall() &&
    !cj1.isIndirectCall() && !cj1.isReturn() && cj1.isJump() &&
    !cj1.isConditionalJump() && cj1.isUnconditionalJump() &&
    !cj1.isIndirectJump() && !cj1.isAsmDataDirective() &&
    !cj1.hasSideEffects() );
  ...
  ufAssert(
    !cjal1.isImplicitMemoryAccess() && !cjal1.isMemoryStore() &&
  ...
  ufAssert(
    !cjalr1.isImplicitMemoryAccess() && !cjalr1.isMemoryStore() &&
  ...
  ufAssert(
    !cjr1.isImplicitMemoryAccess() && !cjr1.isMemoryStore() &&
    !cjr1.isMemoryLoad() && !cjr1.isMove() && !cjr1.isCall() &&
    !cjr1.isIndirectCall() && !cjr1.isReturn() && cjr1.isJump() &&
    !cjr1.isConditionalJump() && !cjr1.isUnconditionalJump() &&
    cjr1.isIndirectJump() && !cjr1.isAsmDataDirective() &&
    !cjr1.hasSideEffects() );
  ...
  ufAssert(
    !cli1.isImplicitMemoryAccess() && !cli1.isMemoryStore() &&
    !cli1.isMemoryLoad() && !cli1.isMove() && !cli1.isCall() &&
    !cli1.isIndirectCall() && !cli1.isReturn() && !cli1.isJump() &&
    !cli1.isConditionalJump() && !cli1.isUnconditionalJump() &&
    !cli1.isIndirectJump() && !cli1.isAsmDataDirective() &&
    !cli1.hasSideEffects() );

  WIR_Operation clui1(
    RV32IMC::OpCode::CLUI, RV32IMC::OperationFormat::SRC20_1,
    new WIR_RegisterParameter( x1, WIR_Usage::def ),
    new RV_NZConst20_Unsigned( 0xFFFE0 ) );
  ufAssert( clui1.getSize() == 2 );
  ufAssert(
    !clui1.isImplicitMemoryAccess() && !clui1.isMemoryStore() &&
  ...
  WIR_Operation clw1(
    RV32IMC::OpCode::CLW, RV32IMC::OperationFormat::SRC7R_1,
    new WIR_RegisterParameter( x1, WIR_Usage::def ),
    new RV_Const7_Unsigned( 16 ),
    new WIR_RegisterParameter( x2, WIR_Usage::use ) );
  ufAssert( clw1.getSize() == 2 );
  ufAssert(
    !clw1.isImplicitMemoryAccess() && !clw1.isMemoryStore() &&
    clw1.isMemoryLoad() && !clw1.isMove() && !clw1.isCall() &&
    !clw1.isIndirectCall() && !clw1.isReturn() && !clw1.isJump() &&
    !clw1.isConditionalJump() && !clw1.isUnconditionalJump() &&
    !clw1.isIndirectJump() && !clw1.isAsmDataDirective() &&
    !clw1.hasSideEffects() );

  WIR_Operation clwsp1(
    RV32IMC::OpCode::CLWSP, RV32IMC::OperationFormat::SRC8R_1,
    new WIR_RegisterParameter( x1, WIR_Usage::def ),
    new RV_Const8_Unsigned( 4 ),
    new WIR_RegisterParameter( riscv.x2(), WIR_Usage::use ) );
  ufAssert( clwsp1.getSize() == 2 );
  ufAssert(
    !clwsp1.isImplicitMemoryAccess() && !clwsp1.isMemoryStore() &&
  ...
  ufAssert(
    !cmv1.isImplicitMemoryAccess() && !cmv1.isMemoryStore() &&
    !cmv1.isMemoryLoad() && cmv1.isMove() && !cmv1.isCall() &&
    !cmv1.isIndirectCall() && !cmv1.isReturn() && !cmv1.isJump() &&
    !cmv1.isConditionalJump() && !cmv1.isUnconditionalJump() &&
    !cmv1.isIndirectJump() && !cmv1.isAsmDataDirective() &&
    !cmv1.hasSideEffects() );
  ...
  ufAssert(
    !cnop1.isImplicitMemoryAccess() && !cnop1.isMemoryStore() &&
  ...
  ufAssert(
    !cor1.isImplicitMemoryAccess() && !cor1.isMemoryStore() &&
    !cor1.isMemoryLoad() && !cor1.isMove() && !cor1.isCall() &&
    !cor1.isIndirectCall() && !cor1.isReturn() && !cor1.isJump() &&
    !cor1.isConditionalJump() && !cor1.isUnconditionalJump() &&
    !cor1.isIndirectJump() && !cor1.isAsmDataDirective() &&
    !cor1.hasSideEffects() );
  ...
  ufAssert(
    !cslli1.isImplicitMemoryAccess() && !cslli1.isMemoryStore() &&
  ...
  ufAssert(
    !csrai1.isImplicitMemoryAccess() && !csrai1.isMemoryStore() &&
  ...
  ufAssert(
    !csrli1.isImplicitMemoryAccess() && !csrli1.isMemoryStore() &&
  ...
  WIR_Operation csw1(
    RV32IMC::OpCode::CSW, RV32IMC::OperationFormat::SRC7R_2,
    new WIR_RegisterParameter( x1, WIR_Usage::use ),
    new RV_Const7_Unsigned( 16 ),
    new WIR_RegisterParameter( x2, WIR_Usage::use ) );
  ufAssert( csw1.getSize() == 2 );
  ufAssert(
    !csw1.isImplicitMemoryAccess() && csw1.isMemoryStore() &&
    !csw1.isMemoryLoad() && !csw1.isMove() && !csw1.isCall() &&
    !csw1.isIndirectCall() && !csw1.isReturn() && !csw1.isJump() &&
    !csw1.isConditionalJump() && !csw1.isUnconditionalJump() &&
    !csw1.isIndirectJump() && !csw1.isAsmDataDirective() &&
    !csw1.hasSideEffects() );

  WIR_Operation cswsp1(
    RV32IMC::OpCode::CSWSP, RV32IMC::OperationFormat::SRC8R_2,
    new WIR_RegisterParameter( x1, WIR_Usage::use ),
    new RV_Const8_Unsigned( 4 ),
    new WIR_RegisterParameter( riscv.x2(), WIR_Usage::use ) );
  ufAssert( cswsp1.getSize() == 2 );
  ufAssert(
    !cswsp1.isImplicitMemoryAccess() && cswsp1.isMemoryStore() &&
  ...
  ufAssert(
    !cxor1.isImplicitMemoryAccess() && !cxor1.isMemoryStore() &&
