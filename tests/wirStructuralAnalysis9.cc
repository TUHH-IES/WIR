...
int main( void )
{
  ...
  b1.rbegin()->get().begin()->get().addJumpTarget( b8 );
  ...
  b5.pushBackInstruction(
    { { MIPS::OpCode::JR, MIPS::OperationFormat::R_2,
        WIR_RegisterParameter( r1, WIR_Usage::use ) } } );
  b5.rbegin()->get().begin()->get().addJumpTarget( b6 );
  b5.rbegin()->get().begin()->get().addJumpTarget( b7 );

  b6.pushBackInstruction(
    { { MIPS::OpCode::JR, MIPS::OperationFormat::R_2,
        WIR_RegisterParameter( r1, WIR_Usage::use ) } } );
  b6.rbegin()->get().begin()->get().addJumpTarget( b5 );
  b6.rbegin()->get().begin()->get().addJumpTarget( b7 );

  b7.pushBackInstruction(
    { { MIPS::OpCode::JR, MIPS::OperationFormat::R_2,
        WIR_RegisterParameter( r1, WIR_Usage::use ) } } );
  b7.rbegin()->get().begin()->get().addJumpTarget( b9 );

  b8.pushBackInstruction(
    { { MIPS::OpCode::JR, MIPS::OperationFormat::R_2,
        WIR_RegisterParameter( r1, WIR_Usage::use ) } } );
  b8.rbegin()->get().begin()->get().addJumpTarget( b9 );
