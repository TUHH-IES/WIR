...
Ü{\itshape archDir}Übitincludedir      = ${includedir}/arch/Ü{\itshape archDir}Ü/analyses/bit
Ü{\itshape archDir}Übitinclude_HEADERS = arch/Ü{\itshape archDir}Ü/analyses/bit/Ü{\itshape newModel}Übitdfa.h
\end{lstlisting}
