...
int main( void )
{
  ...
  ufAssert( r3.getType() == ARMv4::RegisterType::hi );
  ufAssert( r3.getBitWidth() == 32 );
  ufAssert( r3.isVirtual() );
  ufAssert( !r3.isPhysical() );
  ufAssert( r3.isInserted() );
  str.str( "" );
  str << ARMv4::RegisterType::hi.getPrefixes()[ 1 ] << r3.getID()
      << ARMv4::RegisterType::hi.getSuffixes()[ 1 ];
