...
int main( void )
{
 ...
 // Evaluate analysis results.
  ufAssert( uval( srli1, 1 ).extract( 0, 8 ).containsOnlyBit( WIR_L4::bX ) );
  ufAssert( uval( srli1, 1 ).extract( 8, 8 ).getSignedValue() == 64 );
  ufAssert( uval( srli1, 1 ).extract( 16, 8 ).getSignedValue() == 123 );
  ufAssert( uval( srli1, 1 ).extract( 24, 8 ).getSignedValue() == 56 );

  ufAssert( dval( srli1, 0 ).extract( 0, 32 ).getSignedValue() == 3701568 );

  ufAssert( uval( srli2, 1 ).extract( 0, 8 ).getSignedValue() == 64 );
  ufAssert( uval( srli2, 1 ).extract( 8, 8 ).getSignedValue() == 123 );
  ufAssert( uval( srli2, 1 ).extract( 16, 8 ).getSignedValue() == 56 );
  ufAssert( uval( srli2, 1 ).extract( 24, 8 ).containsOnlyBit( WIR_L4::bX ) );

  ufAssert( dval( srli2, 0 ).extract( 0, 32 ).getSignedValue() == 947601408 );
