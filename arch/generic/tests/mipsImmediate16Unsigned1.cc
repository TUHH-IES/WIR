...
int main( void )
{
  ...
  MIPS_Immediate16_Unsigned p1( 0 );
  MIPS_Immediate16_Unsigned p2( 1 );
  MIPS_Immediate16_Unsigned p3( 815 );
  ...
  MIPS_Immediate16_Unsigned p7( std::move( p4 ) );
  MIPS_Immediate16_Unsigned p8( std::move( p5 ) );
  MIPS_Immediate16_Unsigned p9( std::move( p6 ) );

  ufAssert( p7.getType() == WIR_ParameterType::imm );
  ufAssert( p7.getType() == p8.getType() );
  ufAssert( p8.getType() == p9.getType() );

  ufAssert( p7.getValue() == 42 );
  ...
  MIPS_Immediate16_Unsigned p10( 4711 );
  p10 = p1;
  MIPS_Immediate16_Unsigned p11( 26361 );
  p11 = p2;
  MIPS_Immediate16_Unsigned p12( 4 );
  p12 = p3;
  ...
  MIPS_Immediate16_Unsigned p13( 80 );
  p13 = std::move( p10 );
  MIPS_Immediate16_Unsigned p14( 333 );
  p14 = std::move( p11 );
  MIPS_Immediate16_Unsigned p15( 4 );
  p15 = std::move( p12 );
  ...
  MIPS_Immediate16_Unsigned p16( 0 );
  MIPS_Immediate16_Unsigned p17( 65535 );
